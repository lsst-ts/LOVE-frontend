...
* Update package.json version to v6.12.0. `<https://github.com/lsst-ts/LOVE-frontend/pull/798>`_
...
* Update package.json version to v6.11.1. `<https://github.com/lsst-ts/LOVE-frontend/pull/775>`_
...
* Update package.json version to v6.10.0. `<https://github.com/lsst-ts/LOVE-frontend/pull/749>`_
...
* Update package.json version to v6.8.1. `<https://github.com/lsst-ts/LOVE-frontend/pull/725>`_
