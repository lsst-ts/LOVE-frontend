!(function () {
  ...
  function v(t) {
    function n(t, n) {
      ...
      return [
        (1 + h) * Math.sin(t),
        (e * n > -Math.atan2(u, o) - 0.001 ? 0 : 10 * -e) + i + Math.sin(n) * r - (1 + h) * a * u,
      ];
    }
    var a = Math.sin(t),
      r = Math.cos(t),
      ...
      (a.stream = function (n) {
        ...
        return (
          ...
          (M.sphere = function () {
            ...
            for (var n = 0, a = 360 / t, r = (2 * pa) / t, u = 90 - 180 / t, M = wa; t > n; ++n, u -= a, M -= r)
  ...
  function _(t) {
    function n(n, a) {
      ...
      for (var c = u.slice(), M = 0; 3 > M; ++M) {
        ...
        o[M][1] < 0 && (v = -v),
          M
            ? 1 == M
              ? ((v = i - v), (c[0] -= o[M][0] * Math.cos(v)), (c[1] -= o[M][0] * Math.sin(v)))
              : ((v = h - v), (c[0] += o[M][0] * Math.cos(v)), (c[1] += o[M][0] * Math.sin(v)))
            : ((c[0] += o[M][0] * Math.cos(v)), (c[1] -= o[M][0] * Math.sin(v)));
      }
    ...
    for (var a, r = t[2], e = 0; 3 > e; ++e, r = a)
      (a = t[e]), (r.v = B(a[1] - r[1], r[3], r[2], a[3], a[2], a[0] - r[0])), (r.point = [0, 0]);
      ...
      (a.invert = function (n, a) {
        ...
        if (o > e) {
          ...
          for (var s = n - wa, c = Math.sin(n), f = a / c, v = wa > n ? 1 / 0 : 0, l = 10; ; ) {
            ...
            f -= v =
              (f * c - w * s - a) / (c - (2 * s * (p * (d + f * g * Math.cos(d) - b) - g * (g - f * b))) / (p * p));
          }
  ...
  function an(t, n) {
    var a = t * t,
      r = n * n;
    return [t * (1 - 0.162388 * r) * (0.87 - 952426e-9 * a * a), n * (1 + r / 12)];
  }
  function rn(t) {
    function n() {
      var t = !1,
  ...
  function Mn(t, n) {
    ...
    for (r = Math.sqrt(1 - n), i = 1; Math.abs(s[c] / u[c]) > da && 8 > c; )
      (a = u[c++]), (s[c] = 0.5 * (a - r)), (u[c] = 0.5 * (a + r)), (r = M(a * r)), (i *= 2);
    e = i * u[c] * t;
    ...
    return (
      ...
      (a.rotate = function (n) {
        return arguments.length
          ? (r.call(a, [n[0], n[1] - 180 * (t / pa)]), o.origin([-n[0], -n[1]]), a)
      ...
      (a.stream = function (t) {
        return (
          ...
          (t.sphere = function () {
            ...
            for (t.lineEnd(), r = o.angle(90 + a)().coordinates[0], e = r.length - 1, t.lineStart(); --i >= 0; )
              t.point((n = r[i])[0], n[1]);
  ...
  function mn(t, n) {
    for (
      ...
      20 > e && ((n -= a = (n + Math.sin(n) - r) / (1 + Math.cos(n))), !(Math.abs(a) < da));
      e++
    );
    return [0.85 * t * Math.cos((n *= 0.5)), Math.sin(n) * (0 > n ? 1.93052 : 1.75859)];
  }
  function yn(t) {
    function n(n, s) {
      var c,
  ...
  function zn(t, n) {
    ...
    return [
      ...
      n * (1.00384 + a * (0.0802894 + r * -0.02855 + 199025e-9 * a) + r * (0.0998909 + r * -0.0491032)),
    ];
  }
  function Bn(t, n) {
    ...
    function n(n, e) {
      var o = e - t,
        i =
          Math.abs(o) < da
            ? n * a
            : Math.abs((i = pa / 4 + e / 2)) < da || Math.abs(Math.abs(i) - wa) < da
              ? 0
    ...
    return (
      (n.invert = function (n, e) {
        ...
        return [
          Math.abs(e) < da
            ? n / a
            : Math.abs((o = pa / 4 + i / 2)) < da || Math.abs(Math.abs(o) - wa) < da
              ? 0
  ...
  function An(t) {
    function n(n, r) {
      for (
        ...
        (s = t[M]), (c = s[0] + h * (e = c) - u * f), (f = s[1] + h * f + u * e);
  ...
  function Dn(t, n) {
    for (
      ...
      25 > o &&
      ((e -= a = (Math.sin(e / 2) + Math.sin(e) - r) / (0.5 * Math.cos(e / 2) + Math.cos(e))), !(Math.abs(a) < da));
      o++
    );
    return [
  ...
  function Ln(t, n) {
    for (
      var a, r = Math.sqrt(6 / (4 + pa)), e = (1 + pa / 4) * Math.sin(n), o = n / 2, i = 0;
      25 > i && ((o -= a = (o / 2 + Math.sin(o) - e) / (0.5 + Math.cos(o))), !(Math.abs(a) < da));
      i++
    );
  ...
  function On(t, n) {
    var a = n * n,
      r = a * a;
    return [
      t * (0.8707 - 0.131979 * a + r * (-0.013791 + r * (0.003971 * a - 0.001529 * r))),
      n * (1.007226 + a * (0.015085 + r * (-0.044475 + 0.028874 * a - 0.005916 * r))),
    ];
  }
  function Hn(t, n) {
    ...
    return (
      (n.invert = function (n, r) {
        ...
        var v = n * (s = Math.tan(i)),
          l = Math.tan(Math.abs(r) < Math.abs(i + 1 / s) ? 0.5 * h(v) : 0.5 * u(v) + pa / 4) / Math.sin(i);
  ...
  function Nn(t, n) {
    ...
    return [
      ...
      (n > 0 ? wa : -wa) * (M + (o * (c - h)) / 2 + (o * o * (c - 2 * M + h)) / 2),
    ];
  }
  function Un(t) {
    function n(n, a) {
  ...
  (d3.geo.interrupt = function (t) {
    ...
    (q.invert = function (t, n) {
      ...
      var a = t * t,
        ...
        c = b(M),
        f = c * c - s * s;
      return [2 * i(t) * Math.atan2(d(M) * s, 0.25 - f), 2 * i(n) * Math.atan2(c * Math.sin(u), 0.25 + f)];
    }),
      ...
      do
        (r = o - Math.SQRT2 * Math.sin(i)),
          (i -= a =
            ...
            (2 * Math.cos(2 * i) + 2 + pa * Math.cos(r) * Math.SQRT2 * Math.cos(i)));
  ...
  var Fa = nn(2.583819, -0.835827, 0.170354, -0.038094, 1.543313, -0.411435, 0.082742);
  ...
  var Aa = nn(2.6516, -0.76534, 0.19123, -0.047094, 1.36289, -0.13965, 0.031762);
  ((d3.geo.ginzburg9 = function () {
    ...
    (fn.invert = function (t, n) {
      ...
      return [u, 2 * Math.atan(Math.exp((0.5 / o) * Math.log(a * h[0] * h[0] + a * h[1] * h[1]))) - wa];
    }),
    (d3.geo.guyou = rn(fn)),
  ...
  (qn.invert = function (t, n) {
    ...
    (mn.invert = function (t, n) {
      var a =
        Math.abs((a = n * (0 > n ? 0.5179951515653813 : 0.5686373742600607))) > 1 - da ? (a > 0 ? wa : -wa) : h(a);
      return [
        (1.1764705882352942 * t) / Math.cos(a),
        Math.abs((a = ((a += a) + Math.sin(a)) * (0 > n ? 0.4102345310814193 : 0.3736990601468637))) > 1 - da
          ? a > 0
            ? wa
            : -wa
          : h(a),
    ...
    (zn.invert = function (t, n) {
      ...
      do {
        var o = a * a,
          h = r * r,
          u = a * r,
          M = a * (0.975534 + h * (-0.119161 + o * -0.0143059 + h * -0.0547009)) - t,
          s = r * (1.00384 + o * (0.0802894 + h * -0.02855 + 199025e-9 * o) + h * (0.0998909 + h * -0.0491032)) - n,
          c = 0.975534 - h * (0.119161 + 0.0143059 * 3 * o + 0.0547009 * h),
          f = -u * (0.238322 + 0.2188036 * h + 0.0286118 * o),
          v = u * (0.1605788 + 7961e-7 * o + -0.0571 * h),
          l = 1.00384 + o * (0.0802894 + 199025e-9 * o) + h * (3 * (0.0998909 - 0.02855 * o) - 0.245516 * h),
          g = f * v - l * c,
          d = (s * f - M * l) / g,
          b = (M * v - s * c) / g;
        (a -= d), (r -= b);
  ...
  ((d3.geo.modifiedStereographic = Gn).raw = An),
    ...
    (Ln.invert = function (t, n) {
      ...
      return (
        ...
        [(1.5 * t) / (a * (0.5 + Math.cos(r))), h((r / 2 + Math.sin(r)) / (1 + pa / 4))]
      );
    }),
    ...
    (On.invert = function (t, n) {
      ...
      do {
        var o = r * r,
          i = o * o;
        r -= a =
          (r * (1.007226 + o * (0.015085 + i * (-0.044475 + 0.028874 * o - 0.005916 * i))) - n) /
          (1.007226 + o * (0.045255 + i * (-0.311325 + 0.259866 * o - 0.005916 * 11 * i)));
      } while (Math.abs(a) > da && --e > 0);
      return [t / (0.8707 + (o = r * r) * (-0.131979 + o * (-0.013791 + o * o * o * (0.003971 - 0.001529 * o)))), r];
    }),
  ...
  Za.forEach(function (t) {
    ...
    (aa.invert = function (t, n) {
      ...
      return [
        i(t) * pa * (o - r),
        i(n) * wa * Math.sin(2 * Math.atan2(Math.sqrt((1 - 2 * r * a) * (r + o) - a), Math.sqrt(o + r + a))),
      ];
    }),
  ...
  ((d3.geo.wagner4 = function () {
    ...
    (ia.invert = function (t, n) {
      var a = t / 2.66723,
        ...
        e = Math.sqrt(a * a + r * r),
        o = 2 * h(e / 2);
      return [3 * Math.atan2(t * Math.tan(o), 2.66723 * e), e && h((n * Math.sin(o)) / (1.24104 * 0.90631 * e))];
    }),
