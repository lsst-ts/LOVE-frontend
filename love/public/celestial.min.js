...
!(function () {
  ...
  function a(t, e) {
    ...
    return e
      ? ((i = t[0]),
        ...
        (s = e[1]),
        (o = e[2]),
        (a = Math.sin(l) * Math.sin(s) - Math.cos(l) * Math.cos(s) * Math.cos(i)),
        Math.abs(a) < 1e-5 && (a = -Math.cos(l + s) + Math.cos(l) * Math.cos(s) * (1 - Math.cos(i))),
        (n = -Math.cos(l) * Math.sin(i)),
        (c = 0 !== a || 0 !== n ? Math.atan2(n, a) : i - Math.PI),
        (d = o + c),
        d > Math.PI && (d -= ft),
        i % Math.PI == 0
          ? ((p = l + Math.cos(i) * s), p > mt && (p = Math.PI - p), p < -mt && (p = -Math.PI - p))
          : ((r = Math.sin(l) * Math.cos(s) + Math.cos(l) * Math.sin(s) * Math.cos(i)),
            Math.abs(r) > 0.99
              ? ((p = Math.abs(Math.acos(Math.sqrt(a * a + n * n)))), r < 0 && (p *= -1))
              : (p = Math.asin(r))),
        [d, p])
      : t;
  }
  ...
  function c(t) {
    for (var e = {}, a = t.features, n = 0; n < a.length; n++)
      e[a[n].id] = { center: a[n].properties.display.slice(0, 2), scale: a[n].properties.display[2] };
    return e;
  }
  function d(t) {
    var e = {
  ...
  function u(t, e) {
    ...
    for (var n = 0; n < e.length; n++)
      switch (e[n]) {
        ...
        case 'outline':
          'lon' === t
            ? ((a = a.concat(f(t, $.center[1] - 89.99, 'S'))), (a = a.concat(f(t, $.center[1] + 89.99, 'N'))))
            : ((a = a.concat(f(t, $.center[0] - 179.99, 'E'))), (a = a.concat(f(t, $.center[0] + 179.99, 'W'))));
          break;
        default:
          if (x(e[n])) {
  ...
  function h(t) {
    for (var e = [], a = 0; a < t.length; a++) {
      var n = { type: 'Feature', id: a, properties: {}, geometry: { type: 'Point' } };
  ...
  function I(t) {
    if (t) {
      var e = t.split('.');
      if (!(e.length < 1) && ((e = e[0].split('-')), (e[0] = e[0].replace(/\D/g, '')), e[0]))
        return (
  ...
  function q(t, e, a) {
    return (
      (t = (t * yt + ft) % ft),
      (e = (e * yt + ft) % ft),
      Math.abs(t - e) > Math.PI && (t > e ? (t -= ft) : e > t && (e -= ft)),
  ...
  function L(t) {
    ...
    function c(t) {
      ...
      if ('---' === t)
        return (
          ...
          (a = tt.zoomBy()),
          1 !== a && n.push({ param: 'zoom', value: 1 / a, duration: 0 }),
          void tt.animate(n, !1)
        );
      if (S(tt.constellations) && k(tt.constellations, t)) {
        ...
        var i = 1 + 360 / s.scale;
        n.push({ param: 'zoom', value: i, duration: 0 }), (tt.constellation = t), tt.animate(n, !1);
      }
    }
    function d() {
      var t,
    ...
    function u(t) {
      ...
      return (
        k(zt.dsonames[m.culture].names, t) ? (m.dsos.namesType = t) : (m.dsos.namesType = 'desig'),
        k(zt.starnames[m.culture].propername, t) ? (m.stars.propernameType = t) : (m.stars.propernameType = 'desig'),
        Object.assign(bt, m),
        h(),
        U(),
        m
    ...
    w.append('label').attr('title', 'Map width in pixel, 0 indicates full width').attr('for', 'width').html('Width '),
      w
        .append('input')
        .attr('type', 'number')
        .attr('maxlength', '4')
    ...
    var x = w.append('select').attr('id', 'projection').on('change', r),
      ...
      j = Object.keys(y).map(function (t, e) {
        ...
        return t === m.projection && (T = e), { o: t, n: a };
      });
    x
      .selectAll('option')
      .data(j)
      ...
      w
        ...
        .on('change', s),
      w.append('span').html('°'),
      w.append('label').attr('title', 'Orientation').attr('for', 'centerz').html('Orientation'),
      w
        .append('input')
        .attr('type', 'number')
        .attr('id', 'centerz')
        ...
        .on('change', s),
      w.append('span').html('°'),
      w.append('label').attr('for', 'orientationfixed').attr('class', 'advanced').html('Fixed'),
      w
        .append('input')
        .attr('type', 'checkbox')
      ...
      w.append('label').attr('class', 'header').attr('for', 'stars-show').html('Stars'),
      w
        .append('input')
        .attr('type', 'checkbox')
        .attr('id', 'stars-show')
        ...
        .on('change', d),
      w.append('label').attr('for', 'stars-limit').html('down to magnitude'),
      w
        .append('input')
        .attr('type', 'number')
        .attr('id', 'stars-limit')
        ...
        .attr('step', '0.1')
        .on('change', d),
      w.append('label').attr('for', 'stars-colors').html('with spectral colors'),
      w
        .append('input')
        .attr('type', 'checkbox')
        ...
        .on('change', d),
      w.append('label').attr('for', 'stars-color').html('or default color '),
      w
        .append('input')
        .attr('type', 'color')
        ...
        I.length > 1
          ? (w
            ...
            (j = I.map(function (t, e) {
              return t === m.stars[A + 'Type'] && (T = e), { o: t, n: P[A][t] };
            })),
            x
              .selectAll('option')
              .data(j)
    ...
    w.append('br'),
      ...
      w
        ...
        .attr('step', '0.1')
        .on('change', d),
      w.append('label').attr('for', 'stars-exponent').attr('class', 'advanced').html(' * e ^ (exponent'),
      w
        .append('input')
        .attr('type', 'number')
        ...
        .attr('step', '0.01')
        .on('change', d),
      w.append('span').attr('class', 'advanced').text(' * (magnitude + 2))  [* adaptation]'),
      D(W('stars-show')),
      ...
      w
        ...
        .attr('step', '0.1')
        .on('change', d),
      w.append('label').attr('for', 'dsos-colors').html('with symbol colors'),
      w
        .append('input')
        .attr('type', 'checkbox')
        .attr('id', 'dsos-colors')
        ...
        .on('change', d),
      w.append('label').attr('for', 'dsos-color').html('or default color '),
      w
        .append('input')
        .attr('type', 'color')
        .attr('autocomplete', 'off')
    ...
    w.append('label').attr('for', 'dsos-nameLimit').html('down to mag'),
      ...
      w
        ...
        .on('change', d),
      D(W('dsos-show')),
      (w = b.append('div').attr('class', 'col').attr('id', 'constellations')),
        ...
        L.length > 1
          ? (w
            ...
            (j = L.map(function (t, e) {
              return t === m.constellations[A + 'Type'] && (T = e), { o: t, n: P[A][t] };
            })),
            x
              .selectAll('option')
              .data(j)
    ...
    w.append('label').attr('for', 'constellations-lines').html(' lines'),
      w
        ...
        .on('change', d),
      w.append('label').attr('for', 'constellations-bounds').html(' boundaries'),
      w
        .append('input')
        .attr('type', 'checkbox')
      ...
      w.append('label').attr('title', 'Latitude/longitude grid lines').attr('for', 'lines-graticule').html('Graticule'),
      w
        .append('input')
        .attr('type', 'checkbox')
      ...
      w
        ...
        .on('change', d),
      w.append('label').attr('for', 'lines-galactic').html('Galactic plane'),
      w
        .append('input')
        .attr('type', 'checkbox')
        ...
        .on('change', d),
      w.append('label').attr('for', 'lines-supergalactic').html('Supergalactic plane'),
      w
        .append('input')
        .attr('type', 'checkbox')
      ...
      w.append('input').attr('type', 'checkbox').attr('id', 'mw-show').property('checked', m.mw.show).on('change', d),
      w.append('label').attr('for', 'mw-style-fill').attr('class', 'advanced').html(' color'),
      w
        .append('input')
        .attr('type', 'color')
        ...
        .on('change', d),
      w.append('label').attr('for', 'mw-style-opacity').attr('class', 'advanced').html(' opacity'),
      w
        .append('input')
        .attr('type', 'number')
      ...
      w.append('input').attr('type', 'checkbox').attr('id', 'advanced').property('checked', m.advanced).on('change', d),
      w.append('br'),
      w.append('label').attr('for', 'background-fill').html('Background color'),
      w
        .append('input')
        .attr('type', 'color')
        ...
        .on('change', d),
      w.append('label').attr('for', 'background-opacity').attr('class', 'advanced').html('opacity'),
      w
        .append('input')
        .attr('type', 'number')
    ...
    var F = St[m.culture];
    (T = 0),
      w.append('label').attr('title', 'General language setting').attr('for', 'lang').html('Object names '),
      (x = w.append('select').attr('id', 'lang').on('change', d)),
      (j = F.map(function (t, e) {
        return t === m.lang && (T = e), { o: t, n: zt.constellations[m.culture].names[t] };
      })),
      (j = [{ o: '---', n: '(Select language)' }].concat(j)),
      x
        .selectAll('option')
        .data(j)
        .enter()
      ...
      w
        ...
        .on('click', function () {
          ...
          (t.download = i('.png')),
            (t.rel = 'noopener'),
            (t.href = e.toDataURL('image/png').replace('image/png', 'image/octet-stream')),
            t.click(),
            d3.select(t).remove();
        }),
      w
  ...
  function D(t) {
    ...
    switch (a) {
      ...
      case 'stars-designation':
        for (
          e = !W('stars-designation').checked || !W('stars-show').checked, n = 0;
      ...
      case 'stars-propername':
        for (
          e = !W('stars-propername').checked || !W('stars-show').checked, n = 0;
      ...
      case 'dsos-names':
        for (e = !W('dsos-names').checked || !W('dsos-show').checked, n = 0; n < Pt['dsos-names'].length; n++)
          F(Pt['dsos-names'][n], e);
        break;
      case 'planets-show':
        for (e = !W(a).checked, n = 0; n < Pt[a].length; n++) F(Pt[a][n], e);
      case 'planets-names':
        for (e = !W('planets-names').checked || !W('planets-show').checked, n = 0; n < Pt['planets-names'].length; n++)
  ...
  function F(t, e) {
    var a = W(t);
    a &&
      ((a.disabled = e), (a.style.color = e ? '#999' : '#000'), (a.previousSibling.style.color = e ? '#999' : '#000'));
  }
  function O(t, e) {
    var a = j(t);
    d3
      .select('#error')
      .html(e)
      .style({ top: M(a[1] + t.offsetHeight + 1), left: M(a[0]), opacity: 1 }),
      t.focus();
  }
  function _(t) {
    var e,
    ...
    if (t.validity) {
      ...
      if (e.rangeOverflow || e.rangeUnderflow)
        return O(t, t.title + ' must be between ' + (parseInt(t.min) + a) + ' and ' + (parseInt(t.max) - a)), !1;
    } else {
      if (((e = t.value), !x(e))) return O(t, t.title + ': check field value'), !1;
      if ((e = parseFloat(e)) < t.min || e > t.max)
        return O(t, t.title + ' must be between ' + (t.min + a) + ' and ' + (+t.max - a)), !1;
    }
    return d3.select('#error').style({ top: '-9999px', left: '-9999px', opacity: 0 }), !0;
  }
  function E(t) {
    var e;
    if (t.validity) {
    ...
    return a
      ? (e &&
          ('equatorial' === t && 'equatorial' !== e
            ? ((a.value = (a.value / 15).toFixed(1)), a.value < 0 && (a.value += 24))
            : 'equatorial' !== t &&
              'equatorial' === e &&
              ((a.value = (15 * a.value).toFixed(1)), a.value > 180 && (a.value -= 360))),
        'equatorial' === t
          ? ((a.min = '0'), (a.max = '24'), (W('cxunit').innerHTML = 'h'))
          : ((a.min = '-180'), (a.max = '180'), (W('cxunit').innerHTML = '°')),
        a.value)
      : null;
  }
  function C(t, e) {
    ...
    a &&
      ...
      (a.value =
        'equatorial' !== e ? t[0].toFixed(1) : t[0] < 0 ? (t[0] / 15 + 24).toFixed(1) : (t[0] / 15).toFixed(1)),
  ...
  function H() {
    ...
    return (
      ...
      6 !== r.d && ((W('dsos-limit').max = r.d), (W('dsos-nameLimit').max = r.d)),
      (e = s.stars.data),
      (t = e.match(n)),
      null !== t && (r.s = parseFloat(t[t.length - 1])),
      6 != r.s &&
        ((W('stars-limit').max = r.s), (W('stars-designationLimit').max = r.s), (W('stars-propernameLimit').max = r.s)),
      r
    );
  }
  function B(t) {
  ...
  function V(t) {
    ...
    function l() {
      ...
      if ((Object.assign(y, wt.set()), (h = d.parse(W('datetime').value.slice(0, -6))), !isNaN(t) && !isNaN(e))) {
        ...
        (p = tt.getPoint(vt.inverse(a, [90, 0], u), y.transform)),
          (p[2] = 0),
          'zenith' === y.follow ? tt.rotate({ center: p }) : tt.redraw();
      }
    }
    function c(t, e) {
        ...
        d3.json(s, function (e, n) {
          ...
          'FAILED' === n.status
            ? ((m = 60 * Math.round(t[1] / 15)),
              (At = { gmtOffset: 60 * m, message: 'Sea locatation inferred', timestamp: a }))
    ...
    M.append('label').attr('title', 'Location coordinates long/lat').attr('for', 'lat').html('Location'),
      M.append('input')
        .attr('type', 'number')
        .attr('id', 'lat')
        .attr('title', 'Latitude')
      ...
      'geolocation' in navigator &&
        M.append('input').attr('type', 'button').attr('value', 'Here').attr('id', 'here').on('click', a),
      M.append('label').attr('title', 'Local date/time').attr('for', 'datetime').html(' Date/time'),
      M.append('input')
        .attr('type', 'button')
        .attr('id', 'day-left')
      ...
      M.append('input').attr('type', 'button').attr('value', 'Now').attr('id', 'now').on('click', e),
      M.append('br'),
      M.append('label').attr('title', 'Show horizon marker').attr('for', 'horizon-show').html(' Horizon marker'),
      M.append('input')
        .attr('type', 'checkbox')
        .attr('id', 'horizon-show')
        .property('checked', y.horizon.show)
        .on('change', i),
      M.append('label').attr('title', 'Show daylight').attr('for', 'daylight-show').html('Daylight sky'),
      M.append('input')
        .attr('type', 'checkbox')
        ...
        if (A.length > 1) {
          ...
          var L = M.append('select')
            ...
            F = A.map(function (t, e) {
              return t === y.planets[j + 'Type'] && (q = e), { o: t, n: S[j][t] };
            });
          L.selectAll('option')
            .data(F)
            .enter()
    ...
    D(W('planets-show')),
      ...
      (tt.skyview = function (t) {
        ...
        return (
          v.isVisible() && v.hide(),
          k(t, 'timezone') && o(t.timezone) && ((m = t.timezone), (e = !0)),
          k(t, 'date') && T(t.date) && (h.setTime(t.date.valueOf()), (W('datetime').value = r(t.date, m)), (e = !0)),
          k(t, 'location') &&
          s(t.location) &&
          ((u = t.location.slice()), (W('lat').value = u[0]), (W('lon').value = u[1]), !k(t, 'timezone'))
            ? void c(u, !k(t, 'date'))
            : !1 === e
  ...
  function R(t) {
    ...
    function i(t) {
      ...
      return (
        ...
        k(t, 'dash') ? (e['stroke-dasharray'] = t.dash.join(' ')) : (e['stroke-dasharray'] = 'none'),
        (e.font = t.font || null),
        e
      );
    }
    ...
    function p(t, e) {
      ...
      t <= 1.36
        ? ((n = '#daf1fa'), (r = '#93d7f0'), (s = '#57c0e8'), (a = -(1.36 - t) / 10))
        : ((a = (t - 1.36) / (1.885 - 1.36)),
    ...
    function h(t, e) {
      return 0.9 * (1 - (Math.pow(Math.E, t * e) - 1) / (Math.pow(Math.E, e) - 1));
    }
    function f(t) {
    ...
    function I(t) {
      ...
      return (
        ...
        ('symbol' !== E.planets.symbolType && 'letter' !== E.planets.symbolType) ||
          (e.properties.symbol = E.planets.symbols[e.id][E.planets.symbolType]),
        (e.properties.mag = t.ephemeris.mag || 10),
        'lun' === e.id && ((e.properties.age = t.ephemeris.age), (e.properties.phase = t.ephemeris.phase)),
    ...
    var D,
      F,
      O =
        (d3.select('body').append('div').attr('id', 'd3-celestial-svg').attr('style', 'display: none'),
    ...
    for (
      ...
      (Y[$[K]] = O.append('g').attr({ id: $[K], ':inkscape:groupmode': 'layer', ':inkscape:label': $[K] })),
        (J[$[K]] = {});
    var Q = d3.geo.graticule().minorStep([15, 10]),
      Z = d3.geo.path().projection(U),
      X = d3.queue(2);
    if (
      (Y.background.append('path').datum(D).attr('class', 'background').attr('d', Z),
      (J.background.fill = E.background.fill),
      E.lines.graticule.show)
    ) {
      if (
        ('equatorial' === E.transform
          ? (Y.gridLines.append('path').datum(Q).attr('class', 'gridLines').attr('d', Z),
            (J.gridLines = i(E.lines.graticule)))
          : (tt.graticule(Y.gridLines, Z, E.transform), (J.gridLines = i(E.lines.graticule))),
        k(E.lines.graticule, 'lon') && E.lines.graticule.lon.pos.length > 0)
      ) {
        var et = { type: 'FeatureCollection', features: u('lon', E.lines.graticule.lon.pos) };
        Y.gridvaluesLon
      ...
      if (k(E.lines.graticule, 'lat') && E.lines.graticule.lat.pos.length > 0) {
        var at = { type: 'FeatureCollection', features: u('lat', E.lines.graticule.lat.pos) };
        Y.gridvaluesLat
    ...
    E.mw.show &&
      X.defer(function (t) {
        d3.json(N + 'mw.json', function (e, a) {
          ...
          var n = o(a, E.transform),
            r = d(n);
          Y.milkyWay.selectAll('.mway').data(n.features).enter().append('path').attr('class', 'milkyWay').attr('d', Z),
            (J.milkyWay = i(E.mw.style)),
            (!k(E.background, 'opacity') || E.background.opacity > 0.95) &&
              (Y.milkyWayBg
                .selectAll('.mwaybg')
                .data(r.features)
                .enter()
                ...
                .attr('d', Z),
              (J.milkyWayBg = { fill: E.background.fill, 'fill-opacity': E.background.opacity })),
            t(null);
        });
      }),
        ...
        X.defer(function (t) {
          d3.json(N + s('constellations', 'borders'), function (e, a) {
            ...
            Y.constBoundaries
              ...
              .attr('d', Z),
              (J.constBoundaries = i(E.constellations.boundStyle)),
      ...
      X.defer(function (t) {
        var e = U.rotate();
        U.rotate([0, 0, 0]),
          Y.mapBorder.append('path').datum(Q.outline).attr('class', 'mapBorder').attr('d', Z),
          (J.mapBorder = {
            fill: 'none',
        ...
        X.defer(function (t) {
          d3.json(N + E.stars.data, function (e, n) {
            ...
            for (K = b(l[1], 1); K <= b(l[0], 1); K += 0.1)
              J['stars' + Math.round(10 * K).toString()] = { fill: kt(K) };
            E.stars.designation &&
              (Y.starDesignations
        ...
        X.defer(function (t) {
          d3.json(N + E.dsos.data, function (e, n) {
              ...
              .data(
                s.features.filter(function (t) {
                  return (
                    ...
                    ((999 === t.properties.mag && Math.sqrt(parseInt(t.properties.dim)) > E.dsos.limit * W) ||
                      (999 !== t.properties.mag && t.properties.mag <= E.dsos.limit))
                  );
                }),
              )
              .enter()
            ...
            for (nt in E.dsos.symbols)
              k(E.dsos.symbols, nt) &&
                ((F = 'dsos' + nt),
                (J[F] = { 'fill-opacity': E.dsos.style.opacity, 'stroke-opacity': E.dsos.style.opacity }),
                k(E.dsos.symbols[nt], 'stroke')
                  ? ((J[F].fill = 'none'),
                    (J[F].stroke = E.dsos.colors ? E.dsos.symbols[nt].stroke : E.dsos.style.stroke),
                    (J[F]['stroke-width'] = E.dsos.colors ? E.dsos.symbols[nt].width : E.dsos.style.width))
                  : ((J[F].stroke = 'none'),
                    (J[F].fill = E.dsos.colors ? E.dsos.symbols[nt].fill : E.dsos.style.fill)));
            if (E.dsos.names) {
              Y.dsoNames
                .selectAll('.dsonames')
                .data(
                  s.features.filter(function (t) {
                    return (
                      1 === a(t.geometry.coordinates) &&
                      ((999 == t.properties.mag && Math.sqrt(parseInt(t.properties.dim)) > E.dsos.nameLimit) ||
                        (999 != t.properties.mag && t.properties.mag <= E.dsos.nameLimit))
                    );
                  }),
                )
                .enter()
              ...
              for (nt in E.dsos.symbols)
                k(E.dsos.symbols, nt) &&
                  (J[nt] = { fill: E.dsos.colors ? E.dsos.symbols[nt].fill : E.dsos.style.fill });
            }
            t(null);
          });
        }),
        ...
        X.defer(function (t) {
          ...
          if (
            (tt.container.selectAll('.planet').each(function (t) {
              var r = t.id(),
                l = t(n).equatorial(s);
              (l.ephemeris.pos = e(l.ephemeris.pos, gt[E.transform])),
                1 === a(l.ephemeris.pos) && ('lun' === r ? i.features.push(I(l)) : o.features.push(I(l)));
            }),
          ...
          (J.planets = c(E.planets.symbolStyle)),
            ...
            (J.darkluna = { fill: '#557' });
          for (nt in E.planets.symbols) k(E.planets.symbols, nt) && (J[nt] = { fill: E.planets.symbols[nt].fill });
          E.planets.names &&
            (Y.planetNames
      ...
      (E.location || E.formFields.location) &&
        ...
        X.defer(function (t) {
          ...
          if (e) {
            ...
            Y.daylight.append('path').datum(i).attr('class', 'daylight').attr('d', Z),
              (J.daylight = p(s, o)),
              1 === a(r) &&
                s < mt &&
                Y.daylight.append('circle').attr('cx', o[0]).attr('cy', o[1]).attr('r', 5).style('fill', '#fff');
          }
          t(null);
        }),
      (E.location || E.formFields.location) &&
      ...
      X.await(function (e) {
        ...
        if ((R.append('style').attr('type', 'text/css').text(q()), t)) {
          var n = new Blob([a.node().outerHTML], { type: 'image/svg+xml;charset=utf-8' }),
  ...
  var $,
    ...
    Z,
    X,
    tt = { version: '0.7.35', container: null, data: [] },
    et = 0.035,
    at = 1.4,
    nt = 2e3,
    rt = 2500,
  ...
  if (
    ((tt.display = function (a) {
      function r() {
        O(Bt.clip),
          qt.append('path').datum(ae.outline).attr('class', 'outline'),
          qt.append('path').datum(Z).attr('class', 'horizon'),
          qt.append('path').datum(X).attr('class', 'daylight'),
          'equatorial' === $.transform ? ae.minorStep([15, 10]) : ae.minorStep([10, 10]);
        for (var t in $.lines)
          k($.lines, t) &&
            ('graticule' === t
              ? (qt.append('path').datum(ae).attr('class', 'graticule'),
              ...
              : qt
                  .append('path')
                  .datum(d3.geo.circle().angle([90]).origin(e(ht[t], gt[$.transform])))
                  .attr('class', t));
      ...
      function s(t) {
        if (t && 1 !== t) {
          ...
          if ((a < n[0] && (a = n[0]), a > n[1] && (a = n[1]), !0 === $.disableAnimations))
      ...
      function m(e) {
        ...
        if (a) {
          ...
          return o > i[0]
            ...
            : (($.location || $.formFields.location) && (F('horizon-show', a.clip), F('daylight-show', !a.clip)),
              (Y = t(l, u)),
              ($.adaptable = !1),
              d3
                .select({})
                ...
                .tween('projection', function () {
                  (Bt = a),
                    (Gt = Bt.ratio),
                    (Ut = Nt / Bt.ratio),
                    (Wt = x($.background.width) ? Ut + $.background.width : Ut),
                    (Vt = (Bt.scale * Nt) / 1024),
                    Xt.style('width', M(Ct))
                      .style('height', M(Wt))
                      .attr('width', Ct * Ht)
      ...
      function y() {
        ...
        ee.setTransform(Ht, 0, 0, Ht, 0, 0),
          ...
          ($t = $.dsos.size || Rt),
          (Jt = $.dsos.exponent),
          $.orientationfixed && $.center.length > 2 && ((t[2] = $.center[2]), Y.rotate(t)),
          ($.center = [-t[0], -t[1], t[2]]),
          C($.center, $.transform),
          bt(),
          w(),
        ...
        for (var a in $.lines)
          k($.lines, a) &&
            !0 === $.lines[a].show &&
            (T($.lines[a]), qt.selectAll(J + ' .' + a).attr('d', Q), ee.stroke());
        if (
          (k($.lines.graticule, 'lon') &&
            (j($.lines.graticule.lon),
            qt.selectAll(J + ' .graticule_lon').each(function (t, e) {
          ...
          k($.lines.graticule, 'lat') &&
            ...
            qt.selectAll(J + ' .graticule_lat').each(function (t, e) {
              if (S(t.geometry.coordinates)) {
                var a = Y(t.geometry.coordinates);
                vt(a, t.properties.orientation), ee.fillText(t.properties.value, a[0], a[1]);
              }
          ...
          $.constellations.bounds &&
            (qt.selectAll(J + ' .boundaryline').each(function (t) {
              if ((T($.constellations.boundStyle), tt.constellation)) {
                var e = new RegExp('\\b' + tt.constellation + '\\b');
                -1 !== t.ids.search(e) && ((ee.lineWidth *= 1.5), (ee.globalAlpha = 1), ee.setLineDash([]));
              }
              Q(t), ee.stroke();
            }),
            ee.setLineDash([])),
            ...
            qt.selectAll(J + ' .star').each(function (t) {
              if (S(t.geometry.coordinates) && t.properties.mag <= $.stars.limit) {
                ...
                (ee.fillStyle = pt(t)),
                  ...
                  ee.fill(),
                  $.stars.designation &&
                    t.properties.mag <= $.stars.designationLimit * Kt &&
                    (j($.stars.designationStyle), ee.fillText(W(t.id), e[0] + a, e[1])),
                  $.stars.propername &&
                    t.properties.mag <= $.stars.propernameLimit * Kt &&
                    (j($.stars.propernameStyle), ee.fillText(R(t.id), e[0] - a, e[1]));
              }
            })),
          $.dsos.show &&
            qt.selectAll(J + ' .dso').each(function (t) {
              if (S(t.geometry.coordinates) && E(t.properties, $.dsos.limit)) {
                ...
                var n = N(t, e);
                k($.dsos.symbols[a], 'stroke') ? ee.stroke() : ee.fill(),
                  $.dsos.names &&
                    E(t.properties, $.dsos.nameLimit * Kt) &&
                    (j($.dsos.nameStyle),
                    !0 === $.dsos.colors && (ee.fillStyle = $.dsos.symbols[a].fill),
            ...
            if (S(i)) {
              ...
              if (
                ('letter' === $.planets.symbolType
                  ? (j($.planets.symbolStyle), (ee.fillStyle = c.fill), ee.fillText(c.letter, l[0], l[1]))
                  : 'lun' === a
                    ? (k(c, 'size') && x(c.size) && (s = c.size * Kt),
                      (ee.fillStyle = c.fill),
                      Tt.symbol()
                        .type('crescent')
                        .size(s * s)
                    ...
                    : 'disk' === $.planets.symbolType
                      ? ((s = k(c, 'size') && x(c.size) ? c.size * Kt : ft(o.ephemeris)),
                        (ee.fillStyle = c.fill),
                        Tt.symbol()
                          .type('circle')
                          .size(s * s)
                      ...
                      : 'symbol' === $.planets.symbolType &&
                        ...
                        (ee.font = yt($.planets.symbolStyle.font)),
                        (ee.fillStyle = c.fill),
                        ee.fillText(c[$.planets.symbolType], l[0], l[1])),
                $.planets.names)
              ) {
        ...
        if (
          ...
          if (s) {
            ...
            X.origin(i),
              ...
              ee.fill(),
              (ee.fillStyle = '#fff'),
              S(i) && (ee.beginPath(), ee.arc(d[0], d[1], 6, 0, 2 * Math.PI), ee.closePath(), ee.fill());
          }
        }
      ...
      function D(t) {
        var e = v('celestial-zoomin'),
          ...
          n = (Bt.scale * Nt) / 1024;
        e && a && ((e.disabled = t >= n * ot * 0.99), (a.disabled = t <= n));
      }
      function O(t) {
      ...
      function vt(t, e) {
        for (var a = e.split(''), n = 'center', r = 'middle', s = a.length - 1; s >= 0; s--)
          switch (a[s]) {
            case 'N':
              r = 'bottom';
              break;
      ...
      if (Bt) {
        ...
        (Q = d3.geo.path().projection(Y).context(ee)),
          qt ? qt.selectAll(J + ' *').remove() : (qt = d3.select(J).append('container')),
          $.interactive
            ? (Xt.call(K),
          ...
          L($),
          null === v('error') && d3.select('body').append('div').attr('id', 'error'),
          null === v('loc') ? V($) : !0 === $.location && 'zenith' === $.follow && h({ center: tt.zenith() }),
          (!0 !== $.location && !0 !== $.formFields.location) ||
            (d3.select(J + ' #location').style('display', 'inline-block'),
          ...
          (this.metrics = function () {
            return { width: Nt, height: Ut, margin: Et, scale: Y.scale() };
          }),
          (this.setStyle = T),
          (this.setTextStyle = j),
          (this.setStyleA = P),
  ...
  (tt.add = function (t) {
    var e = {};
    return k(t, 'type')
      ? ('dso' !== t.type && 'json' !== t.type) || (k(t, 'file') && k(t, 'callback'))
  ...
  var bt = {},
    wt = {
      ...
      horizon: { show: !1, stroke: '#cccccc', width: 1, fill: '#000000', opacity: 0.4 },
      daylight: { show: !1 },
      planets: {
        show: !1,
      ...
      set: function (t) {
        ...
        return (
          (r.constellations.nameStyle.font = g(r.constellations.nameStyle.font)),
          (r.constellations.nameStyle.opacity = g(r.constellations.nameStyle.opacity)),
          (r.constellations.nameStyle.fill = g(r.constellations.nameStyle.fill)),
          (r.constellations.lineStyle.width = g(r.constellations.lineStyle.width)),
          (r.constellations.lineStyle.opacity = g(r.constellations.lineStyle.opacity)),
          (r.constellations.lineStyle.stroke = g(r.constellations.lineStyle.stroke)),
          Object.assign(bt, r),
          r
        );
      },
      applyDefaults: function (t) {
        ...
        return (
          ...
          t &&
            (k(t, 'stars') &&
              (k(t.stars, 'names') && (e.stars.designation = t.stars.names),
              k(t.stars, 'namelimit') && (e.stars.designationLimit = t.stars.namelimit),
              k(t.stars, 'namestyle') && Object.assign(e.stars.designationStyle, t.stars.namestyle),
              k(t.stars, 'proper') && (e.stars.propername = t.stars.proper),
              k(t.stars, 'propernamelimit') && (e.stars.propernameLimit = t.stars.propernamelimit),
              k(t.stars, 'propernamestyle') && Object.assign(e.stars.propernameStyle, t.stars.propernamestyle)),
            k(t, 'dsos') &&
              (k(t.dsos, 'desig') && !0 === t.dsos.desig && (e.dsos.namesType = 'desig'),
              k(t.dsos, 'namelimit') && (e.dsos.nameLimit = t.dsos.namelimit),
              k(t.dsos, 'namestyle') && Object.assign(e.dsos.nameStyle, t.dsos.namestyle)),
            k(t, 'constellations') &&
              (k(t.constellations, 'show') && !0 === t.constellations.show && (e.constellations.names = !0),
              k(t.constellations, 'desig') && !0 === t.constellations.desig && (e.constellations.namesType = 'desig'),
              'latin' === e.constellations.namesType && (e.constellations.namesType = 'la'),
              'iau' === e.constellations.namesType && (e.constellations.namesType = 'name'),
              k(t.constellations, 'namestyle') && Object.assign(e.constellations.nameStyle, t.constellations.namestyle),
              k(t.constellations, 'linestyle') && Object.assign(e.constellations.lineStyle, t.constellations.linestyle),
              k(t.constellations, 'boundstyle') &&
                Object.assign(e.constellations.boundStyle, t.constellations.boundstyle)),
            k(t, 'planets') && k(t.planets, 'style') && Object.assign(e.planets.style, t.planets.symbolStyle)),
          (e.stars.designationType && '' !== e.stars.designationType) || (e.stars.designationType = 'desig'),
          k(zt.starnames[e.culture].designation, e.stars.designationType) || (e.designationType = 'desig'),
          (e.stars.propernameType && '' !== e.stars.propernameType) || (e.stars.propernameType = 'name'),
          k(zt.starnames[e.culture].propername, e.stars.propernameType) || (e.propernameType = 'name'),
          (e.dsos.namesType && '' !== e.dsos.namesType) || (e.dsos.namesType = 'desig'),
          (e.constellations.namesType && '' !== e.constellations.namesType) || (e.constellations.namesType = 'desig'),
          k(zt.constellations[e.culture].names, e.constellations.namesType) || (e.constellations.namesType = 'name'),
          (e.planets.symbolType && '' !== e.planets.symbolType) || (e.planets.symbolType = 'symbol'),
          (e.planets.namesType && '' !== e.planets.namesType) || (e.planets.namesType = 'desig'),
          k(zt.planets[e.culture].names, e.planets.namesType) || (e.planets.namesType = 'desig'),
          (e.constellations.nameStyle.font = g(e.constellations.nameStyle.font)),
          (e.constellations.nameStyle.opacity = g(e.constellations.nameStyle.opacity)),
          (e.constellations.nameStyle.fill = g(e.constellations.nameStyle.fill)),
          (e.constellations.lineStyle.width = g(e.constellations.lineStyle.width)),
          (e.constellations.lineStyle.opacity = g(e.constellations.lineStyle.opacity)),
          (e.constellations.lineStyle.stroke = g(e.constellations.lineStyle.stroke)),
          Object.assign(bt, e),
          e
        );
      },
  ...
  var kt = d3.scale
    ...
    xt = {
      airy: { n: 'Airy’s Minimum Error', arg: Math.PI / 2, scale: 360, ratio: 1, clip: !0 },
      aitoff: { n: 'Aitoff', arg: null, scale: 162 },
      armadillo: { n: 'Armadillo', arg: 0, scale: 250 },
      august: { n: 'August', arg: null, scale: 94, ratio: 1.4 },
      azimuthalEqualArea: { n: 'Azimuthal Equal Area', arg: null, scale: 340, ratio: 1, clip: !0 },
      azimuthalEquidistant: { n: 'Azimuthal Equidistant', arg: null, scale: 320, ratio: 1, clip: !0 },
      ...
      craig: { n: 'Craig Retroazimuthal', arg: 0, scale: 310, ratio: 1.5, clip: !0 },
      ...
      lagrange: { n: 'Lagrange', arg: Math.PI / 4, scale: 88, ratio: 1.6, clip: !1 },
      ...
      orthographic: { n: 'Orthographic', arg: null, scale: 480, ratio: 1, clip: !0 },
      ...
      stereographic: { n: 'Stereographic', arg: null, scale: 500, ratio: 1, clip: !0 },
      times: { n: 'Times', arg: null, scale: 210, ratio: 1.4 },
      twoPointEquidistant: { n: 'Two-Point Equidistant', arg: Math.PI / 2, scale: 320, ratio: 1.15, clip: !0 },
      vanDerGrinten: { n: 'van Der Grinten', arg: null, scale: 160, ratio: 1 },
      vanDerGrinten2: { n: 'van Der Grinten II', arg: null, scale: 160, ratio: 1 },
      vanDerGrinten3: { n: 'van Der Grinten III', arg: null, scale: 160, ratio: 1 },
  ...
  var zt = {
      ...
      planets: {
        ...
        cn: {
          symbol: { symbol: '☾ Symbol', letter: 'Ⅼ Letter', disk: '● Disk' },
          names: { desig: 'Designation', name: 'Chinese', pinyin: 'Pinyin', en: 'English' },
        },
      },
      dsonames: {
        iau: {
        ...
        cn: { names: { desig: 'Designation', name: 'Chinese', pinyin: 'Pinyin', en: 'English' } },
      },
    },
    St = {
        ...
        (d3.functor([2, 2]),
        {
          ...
          triangle: function (t) {
            var a = Math.sqrt(n()),
              r = a / Math.sqrt(3);
            return (
              t.moveTo(e[0], e[1] - r), t.lineTo(e[0] + r, e[1] + r), t.lineTo(e[0] - r, e[1] + r), t.closePath(), r
            );
          },
          ellipse: function (t) {
            var a = Math.sqrt(n()),
          ...
          crescent: function (t) {
            ...
            return (
              ...
              t.scale(l, 1),
              t.arc(e[0] / l, e[1], s, Math.PI / 2, -Math.PI / 2, d),
              t.closePath(),
              t.fill(),
              t.restore(),
              s
  ...
  var jt = {
      ...
      cartesian: function (t) {
        var e = t[0],
          a = mt - t[1],
          n = t[2];
        return { x: n * Math.sin(a) * Math.cos(e), y: n * Math.sin(a) * Math.sin(e), z: n * Math.cos(a) };
      },
    ...
    _t = function () {
      function t(e) {
        return (
          b(e),
          'sol' === h
            ? ((M.ephemeris.x = 0), (M.ephemeris.y = 0), (M.ephemeris.z = 0), (M.ephemeris.mag = -6), t)
            : (w(), t)
        );
      }
      function e(t, e) {
        for (var a = e > 1 ? t * t : -t * t, n = (e * a * t) / 6, r = (1 - e) * t - n, s = 4; Math.abs(n) > 1e-15; )
          (n *= a / (s * (s + 1))), (r -= n), (s += 2);
        return r;
      }
      function a() {
        var t,
          ...
          u = 0;
        if (!i) return 0;
        if (o < 1 && ((i < -Math.PI || i > Math.PI) && ((r = jt.normalize0(i)), (c = i - r), (i = r)), o < 0.9)) {
        ...
        if (
          ...
          ((o > 0.8 && i < Math.PI / 3) || o > 1) &&
            ((n = i / Math.abs(1 - o)),
            n * n > 6 * Math.abs(1 - o) && (n = i < Math.PI ? Math.pow(6 * i, 1 / 3) : jt.asinh(i / o)),
            (t = n)),
          o > 1 && i > 4 && (t = Math.log(i)),
          o < 1)
        )
          for (; Math.abs(d) > l; )
            (a = u++ > 8 ? e(t, o) - i : t - o * Math.sin(t) - i), (d = -a / (1 - o * Math.cos(t))), (t += d);
        else
          for (; Math.abs(d) > l; )
            (a = u++ > 7 ? -e(t, o) - i : o * jt.sinh(t) - t - i), (d = -a / (o * jt.cosh(t) - 1)), (t += d);
        return p ? c - t : c + t;
      }
      function n() {
        var t,
        ...
        1 === o.e
          ...
          : ((o.E = a()),
            o.e > 1 ? ((t = o.e - jt.cosh(o.E)), (e = jt.sinh(o.E))) : ((t = Math.cos(o.E) - o.e), (e = Math.sin(o.E))),
      ...
      function r() {
        ...
        t.hasOwnProperty('w') || (t.w = t.W - t.N),
          ...
          1 !== t.e
            ? ((t.q = t.a * (1 - t.e)), (t.t0 = t.a * Math.sqrt(Math.abs(t.a) / y)))
            : ((t.w0 = 3 / Math.sqrt(2) / (t.q * Math.sqrt(t.q / y))), (t.a = 0), (t.t0 = 0)),
      ...
      function o(t) {
        var e = M.ephemeris,
          a = t.ephemeris;
        (Lt = (23.439292 - 0.0130042 * e.cy - 1.667e-7 * e.cy * e.cy + 5.028e-7 * e.cy * e.cy * e.cy) * yt),
          (Dt = Math.sin(Lt)),
          (Ft = Math.cos(Lt));
        var n = 'lun' === h ? { x: 0, y: 0, z: 0 } : { x: a.x, y: a.y, z: a.z };
        (e.xeq = e.x - n.x),
      ...
      function i() {
        var t = M.ephemeris,
          ...
          r = 0.666 * ((1 - n / Math.PI) * Math.cos(n) + (1 / Math.PI) * Math.sin(n));
      ...
      function l() {
        var t = M.ephemeris,
          e = t.v + t.w;
        return (
          (t.x = t.r * (Math.cos(t.N) * Math.cos(e) - Math.sin(t.N) * Math.sin(e) * Math.cos(t.i))),
          (t.y = t.r * (Math.sin(t.N) * Math.cos(e) + Math.cos(t.N) * Math.sin(e) * Math.cos(t.i))),
        ...
        w = function () {
          ...
          if ('lun' === h) {
            ...
            for (var a = 0; a < Ot.length; a++)
              (t = Ot[a]), k(v, t) && (k(v, 'd' + t) ? (e[t] = v[t] + v['d' + t] * e.cy) : k(v, t) && (e[t] = v[t]));
        ...
        (t.elements = function (e) {
          ...
          for (var n = 0; n < Ot.length; n++)
            (a = Ot[n]),
              k(e, a) &&
                ((v[a] = e[a]),
                'a' === a || 'e' === a ? (v[a] *= 1) : 'ref' !== a && 'ep' !== a && (v[a] *= yt),
                k(e, 'd' + a) && ((a = 'd' + a), (v[a] = e[a]), (v[a] *= 'da' === a || 'de' === a ? 1 : yt)));
          return t;
        }),
        (t.params = function (e) {
    ...
    Et = {
      elements: function (t) {
        var e = (t.jd - 2451545) / 36525,
          ...
          i = 1e-8 * r,
          l =
            3400.4 * Math.cos(yt * (235.7004 + 890534.223 * e - 32.601 * s + 3.664 * o - 1.769 * i)) -
            635.6 * Math.cos(yt * (100.737 + 413335.3554 * e - 122.571 * s - 10.684 * o + 5.028 * i)) -
            235.6 * Math.cos(yt * (134.9634 + 477198.8676 * e + 89.97 * s + 14.348 * o - 6.797 * i)) +
            218.1 * Math.cos(yt * (238.1713 + 854535.1727 * e - 31.065 * s + 3.623 * o - 1.769 * i)) +
            181 * Math.cos(yt * (10.6638 + 1367733.0907 * e + 57.37 * s + 18.011 * o - 8.566 * i)) -
            39.9 * Math.cos(yt * (103.2079 + 377336.3051 * e - 121.035 * s - 10.724 * o + 5.028 * i)) -
            38.4 * Math.cos(yt * (233.2295 + 926533.2733 * e - 34.136 * s + 3.705 * o - 1.769 * i)) +
            33.8 * Math.cos(yt * (336.4374 + 1303869.5784 * e - 155.171 * s - 7.02 * o + 3.259 * i)) +
            28.8 * Math.cos(yt * (111.4008 + 1781068.4461 * e - 65.201 * s + 7.328 * o - 3.538 * i)) +
            12.6 * Math.cos(yt * (13.1347 + 1331734.0404 * e + 58.906 * s + 17.971 * o - 8.566 * i)) +
            11.4 * Math.cos(yt * (186.5442 + 966404.0351 * e - 68.058 * s - 0.567 * o + 0.232 * i)) -
            11.1 * Math.cos(yt * (222.5657 - 441199.8173 * e - 91.506 * s - 14.307 * o + 6.797 * i)) -
            10.2 * Math.cos(yt * (269.9268 + 954397.7353 * e + 179.941 * s + 28.695 * o - 13.594 * i)) +
            9.7 * Math.cos(yt * (145.6272 + 1844931.9583 * e + 147.34 * s + 32.359 * o - 15.363 * i)) +
            9.6 * Math.cos(yt * (240.6422 + 818536.1225 * e - 29.529 * s + 3.582 * o - 1.769 * i)) +
            8 * Math.cos(yt * (297.8502 + 445267.1115 * e - 16.3 * s + 1.832 * o - 0.884 * i)) -
            6.2 * Math.cos(yt * (132.4925 + 513197.9179 * e + 88.434 * s + 14.388 * o - 6.797 * i)) +
            6 * Math.cos(yt * (173.5506 + 1335801.3346 * e - 48.901 * s + 5.496 * o - 2.653 * i)) +
            3.7 * Math.cos(yt * (113.8717 + 1745069.3958 * e - 63.665 * s + 7.287 * o - 3.538 * i)) +
            3.6 * Math.cos(yt * (338.9083 + 1267870.5281 * e - 153.636 * s - 7.061 * o + 3.259 * i)) +
            3.2 * Math.cos(yt * (246.3642 + 2258267.3137 * e + 24.769 * s + 21.675 * o - 10.335 * i)) -
            3 * Math.cos(yt * (8.1929 + 1403732.141 * e + 55.834 * s + 18.052 * o - 8.566 * i)) +
            2.3 * Math.cos(yt * (98.2661 + 449334.4057 * e - 124.107 * s - 10.643 * o + 5.028 * i)) -
            2.2 * Math.cos(yt * (357.5291 + 35999.0503 * e - 1.536 * s + 0.041 * o + 0 * i)) -
            2 * Math.cos(yt * (38.5872 + 858602.4669 * e - 138.871 * s - 8.852 * o + 4.144 * i)) -
            1.8 * Math.cos(yt * (105.6788 + 341337.2548 * e - 119.499 * s - 10.765 * o + 5.028 * i)) -
            1.7 * Math.cos(yt * (201.474 + 826670.7108 * e - 245.142 * s - 21.367 * o + 10.057 * i)) +
            1.6 * Math.cos(yt * (184.1196 + 401329.0556 * e + 125.428 * s + 18.579 * o - 8.798 * i)) -
            1.4 * Math.cos(yt * (308.4192 - 489205.1674 * e + 158.029 * s + 14.915 * o - 7.029 * i)) +
            1.3 * Math.cos(yt * (325.7736 - 63863.5122 * e - 212.541 * s - 25.031 * o + 11.826 * i)),
          c =
          ...
          d = 383397.6 + l + c * e,
          p =
            0.014217 * Math.cos(yt * (100.737 + 413335.3554 * e - 122.571 * s - 10.684 * o + 5.028 * i)) +
            0.008551 * Math.cos(yt * (325.7736 - 63863.5122 * e - 212.541 * s - 25.031 * o + 11.826 * i)) -
            0.001383 * Math.cos(yt * (134.9634 + 477198.8676 * e + 89.97 * s + 14.348 * o - 6.797 * i)) +
            0.001353 * Math.cos(yt * (10.6638 + 1367733.0907 * e + 57.37 * s + 18.011 * o - 8.566 * i)) -
            0.001146 * Math.cos(yt * (66.5106 + 349471.8432 * e - 335.112 * s - 35.715 * o + 16.854 * i)) -
            915e-6 * Math.cos(yt * (201.474 + 826670.7108 * e - 245.142 * s - 21.367 * o + 10.057 * i)) +
            869e-6 * Math.cos(yt * (103.2079 + 377336.3051 * e - 121.035 * s - 10.724 * o + 5.028 * i)) -
            628e-6 * Math.cos(yt * (235.7004 + 890534.223 * e - 32.601 * s + 3.664 * o - 1.769 * i)) -
            393e-6 * Math.cos(yt * (291.5472 - 127727.0245 * e - 425.082 * s - 50.062 * o + 23.651 * i)) +
            284e-6 * Math.cos(yt * (328.2445 - 99862.5625 * e - 211.005 * s - 25.072 * o + 11.826 * i)) -
            278e-6 * Math.cos(yt * (162.8868 - 31931.7561 * e - 106.271 * s - 12.516 * o + 5.913 * i)) -
            24e-5 * Math.cos(yt * (269.9268 + 954397.7353 * e + 179.941 * s + 28.695 * o - 13.594 * i)) +
            23e-5 * Math.cos(yt * (111.4008 + 1781068.4461 * e - 65.201 * s + 7.328 * o - 3.538 * i)) +
            229e-6 * Math.cos(yt * (167.2476 + 762807.1986 * e - 457.683 * s - 46.398 * o + 21.882 * i)) -
            202e-6 * Math.cos(yt * (83.3826 - 12006.2998 * e + 247.999 * s + 29.262 * o - 13.826 * i)) +
            19e-5 * Math.cos(yt * (190.8102 - 541062.3799 * e - 302.511 * s - 39.379 * o + 18.623 * i)) +
            177e-6 * Math.cos(yt * (357.5291 + 35999.0503 * e - 1.536 * s + 0.041 * o + 0 * i)) +
            153e-6 * Math.cos(yt * (32.2842 + 285608.3309 * e - 547.653 * s - 60.746 * o + 28.679 * i)) -
            137e-6 * Math.cos(yt * (44.8902 + 1431596.6029 * e + 269.911 * s + 43.043 * o - 20.392 * i)) +
            122e-6 * Math.cos(yt * (145.6272 + 1844931.9583 * e + 147.34 * s + 32.359 * o - 15.363 * i)) +
            116e-6 * Math.cos(yt * (302.211 + 1240006.0662 * e - 367.713 * s - 32.051 * o + 15.085 * i)) -
            111e-6 * Math.cos(yt * (203.9449 + 790671.6605 * e - 243.606 * s - 21.408 * o + 10.057 * i)) -
            108e-6 * Math.cos(yt * (68.9815 + 313472.7929 * e - 333.576 * s - 35.756 * o + 16.854 * i)) +
            96e-6 * Math.cos(yt * (336.4374 + 1303869.5784 * e - 155.171 * s - 7.02 * o + 3.259 * i)) -
            9e-5 * Math.cos(yt * (98.2661 + 449334.4057 * e - 124.107 * s - 10.643 * o + 5.028 * i)) +
            9e-5 * Math.cos(yt * (13.1347 + 1331734.0404 * e + 58.906 * s + 17.971 * o - 8.566 * i)) +
            56e-6 * Math.cos(yt * (55.8468 - 1018261.2475 * e - 392.482 * s - 53.726 * o + 25.42 * i)) -
            56e-6 * Math.cos(yt * (238.1713 + 854535.1727 * e - 31.065 * s + 3.623 * o - 1.769 * i)) +
            52e-6 * Math.cos(yt * (308.4192 - 489205.1674 * e + 158.029 * s + 14.915 * o - 7.029 * i)) -
            5e-5 * Math.cos(yt * (133.0212 + 698943.6863 * e - 670.224 * s - 71.429 * o + 33.708 * i)) -
            49e-6 * Math.cos(yt * (267.9846 + 1176142.554 * e - 580.254 * s - 57.082 * o + 26.911 * i)) -
            49e-6 * Math.cos(yt * (184.1196 + 401329.0556 * e + 125.428 * s + 18.579 * o - 8.798 * i)) -
            45e-6 * Math.cos(yt * (49.1562 - 75869.812 * e + 35.458 * s + 4.231 * o - 2.001 * i)) +
            44e-6 * Math.cos(yt * (257.3208 - 191590.5367 * e - 637.623 * s - 75.093 * o + 35.477 * i)) +
            42e-6 * Math.cos(yt * (105.6788 + 341337.2548 * e - 119.499 * s - 10.765 * o + 5.028 * i)) +
            42e-6 * Math.cos(yt * (160.4159 + 4067.2942 * e - 107.806 * s - 12.475 * o + 5.913 * i)) +
            4e-5 * Math.cos(yt * (246.3642 + 2258267.3137 * e + 24.769 * s + 21.675 * o - 10.335 * i)) -
            4e-5 * Math.cos(yt * (156.5838 - 604925.8921 * e - 515.053 * s - 64.41 * o + 30.448 * i)) +
            36e-6 * Math.cos(yt * (169.7185 + 726808.1483 * e - 456.147 * s - 46.439 * o + 21.882 * i)) +
            29e-6 * Math.cos(yt * (113.8717 + 1745069.3958 * e - 63.665 * s + 7.287 * o - 3.538 * i)) -
            29e-6 * Math.cos(yt * (297.8502 + 445267.1115 * e - 16.3 * s + 1.832 * o - 0.884 * i)) -
            28e-6 * Math.cos(yt * (294.0181 - 163726.0747 * e - 423.546 * s - 50.103 * o + 23.651 * i)) +
            27e-6 * Math.cos(yt * (263.6238 + 381403.5993 * e - 228.841 * s - 23.199 * o + 10.941 * i)) -
            26e-6 * Math.cos(yt * (358.0578 + 221744.8187 * e - 760.194 * s - 85.777 * o + 40.505 * i)) -
            26e-6 * Math.cos(yt * (8.1929 + 1403732.141 * e + 55.834 * s + 18.052 * o - 8.566 * i)),
          u = -0.0022 * Math.cos(yt * (103.2 + 377336.3 * e)),
          h = 0.055544 + p + 0.001 * e * u,
          f =
            0.0011776 * Math.cos(yt * (49.1562 - 75869.812 * e + 35.458 * s + 4.231 * o - 2.001 * i)) -
            971e-7 * Math.cos(yt * (235.7004 + 890534.223 * e - 32.601 * s + 3.664 * o - 1.769 * i)) +
            908e-7 * Math.cos(yt * (186.5442 + 966404.0351 * e - 68.058 * s - 0.567 * o + 0.232 * i)) +
            623e-7 * Math.cos(yt * (83.3826 - 12006.2998 * e + 247.999 * s + 29.262 * o - 13.826 * i)) +
            483e-7 * Math.cos(yt * (51.6271 - 111868.8623 * e + 36.994 * s + 4.19 * o - 2.001 * i)) +
            348e-7 * Math.cos(yt * (100.737 + 413335.3554 * e - 122.571 * s - 10.684 * o + 5.028 * i)) -
            316e-7 * Math.cos(yt * (308.4192 - 489205.1674 * e + 158.029 * s + 14.915 * o - 7.029 * i)) -
            253e-7 * Math.cos(yt * (46.6853 - 39870.7617 * e + 33.922 * s + 4.272 * o - 2.001 * i)) -
            141e-7 * Math.cos(yt * (274.1928 - 553068.6797 * e - 54.513 * s - 10.116 * o + 4.797 * i)) +
            127e-7 * Math.cos(yt * (325.7736 - 63863.5122 * e - 212.541 * s - 25.031 * o + 11.826 * i)) +
            117e-7 * Math.cos(yt * (184.1196 + 401329.0556 * e + 125.428 * s + 18.579 * o - 8.798 * i)) -
            78e-7 * Math.cos(yt * (98.3124 - 151739.624 * e + 70.916 * s + 8.462 * o - 4.001 * i)) -
            63e-7 * Math.cos(yt * (238.1713 + 854535.1727 * e - 31.065 * s + 3.623 * o - 1.769 * i)) +
            63e-7 * Math.cos(yt * (134.9634 + 477198.8676 * e + 89.97 * s + 14.348 * o - 6.797 * i)) +
            36e-7 * Math.cos(yt * (321.5076 + 1443602.9027 * e + 21.912 * s + 13.78 * o - 6.566 * i)) -
            35e-7 * Math.cos(yt * (10.6638 + 1367733.0907 * e + 57.37 * s + 18.011 * o - 8.566 * i)) +
            24e-7 * Math.cos(yt * (149.8932 + 337465.5434 * e - 87.113 * s - 6.453 * o + 3.028 * i)) +
            24e-7 * Math.cos(yt * (170.9849 - 930404.9848 * e + 66.523 * s + 0.608 * o - 0.232 * i)),
          m = -0.0203 * Math.cos(yt * (125 - 1934.1 * e)) + 0.0034 * Math.cos(yt * (220.2 - 1935.5 * e)),
          y = 0.0449858 + f + 0.001 * m,
          g =
            -15.448 * Math.sin(yt * (100.737 + 413335.3554 * e - 122.571 * s - 10.684 * o + 5.028 * i)) -
            9.642 * Math.sin(yt * (325.7736 - 63863.5122 * e - 212.541 * s - 25.031 * o + 11.826 * i)) -
            2.721 * Math.sin(yt * (134.9634 + 477198.8676 * e + 89.97 * s + 14.348 * o - 6.797 * i)) +
            2.607 * Math.sin(yt * (66.5106 + 349471.8432 * e - 335.112 * s - 35.715 * o + 16.854 * i)) +
            2.085 * Math.sin(yt * (201.474 + 826670.7108 * e - 245.142 * s - 21.367 * o + 10.057 * i)) +
            1.477 * Math.sin(yt * (10.6638 + 1367733.0907 * e + 57.37 * s + 18.011 * o - 8.566 * i)) +
            0.968 * Math.sin(yt * (291.5472 - 127727.0245 * e - 425.082 * s - 50.062 * o + 23.651 * i)) -
            0.949 * Math.sin(yt * (103.2079 + 377336.3051 * e - 121.035 * s - 10.724 * o + 5.028 * i)) -
            0.703 * Math.sin(yt * (167.2476 + 762807.1986 * e - 457.683 * s - 46.398 * o + 21.882 * i)) -
            0.66 * Math.sin(yt * (235.7004 + 890534.223 * e - 32.601 * s + 3.664 * o - 1.769 * i)) -
            0.577 * Math.sin(yt * (190.8102 - 541062.3799 * e - 302.511 * s - 39.379 * o + 18.623 * i)) -
            0.524 * Math.sin(yt * (269.9268 + 954397.7353 * e + 179.941 * s + 28.695 * o - 13.594 * i)) -
            0.482 * Math.sin(yt * (32.2842 + 285608.3309 * e - 547.653 * s - 60.746 * o + 28.679 * i)) +
            0.452 * Math.sin(yt * (357.5291 + 35999.0503 * e - 1.536 * s + 0.041 * o + 0 * i)) -
            0.381 * Math.sin(yt * (302.211 + 1240006.0662 * e - 367.713 * s - 32.051 * o + 15.085 * i)) -
            0.342 * Math.sin(yt * (328.2445 - 99862.5625 * e - 211.005 * s - 25.072 * o + 11.826 * i)) -
            0.312 * Math.sin(yt * (44.8902 + 1431596.6029 * e + 269.911 * s + 43.043 * o - 20.392 * i)) +
            0.282 * Math.sin(yt * (162.8868 - 31931.7561 * e - 106.271 * s - 12.516 * o + 5.913 * i)) +
            0.255 * Math.sin(yt * (203.9449 + 790671.6605 * e - 243.606 * s - 21.408 * o + 10.057 * i)) +
            0.252 * Math.sin(yt * (68.9815 + 313472.7929 * e - 333.576 * s - 35.756 * o + 16.854 * i)) -
            0.211 * Math.sin(yt * (83.3826 - 12006.2998 * e + 247.999 * s + 29.262 * o - 13.826 * i)) +
            0.193 * Math.sin(yt * (267.9846 + 1176142.554 * e - 580.254 * s - 57.082 * o + 26.911 * i)) +
            0.191 * Math.sin(yt * (133.0212 + 698943.6863 * e - 670.224 * s - 71.429 * o + 33.708 * i)) -
            0.184 * Math.sin(yt * (55.8468 - 1018261.2475 * e - 392.482 * s - 53.726 * o + 25.42 * i)) +
            0.182 * Math.sin(yt * (145.6272 + 1844931.9583 * e + 147.34 * s + 32.359 * o - 15.363 * i)) -
            0.158 * Math.sin(yt * (257.3208 - 191590.5367 * e - 637.623 * s - 75.093 * o + 35.477 * i)) +
            0.148 * Math.sin(yt * (156.5838 - 604925.8921 * e - 515.053 * s - 64.41 * o + 30.448 * i)) -
            0.111 * Math.sin(yt * (169.7185 + 726808.1483 * e - 456.147 * s - 46.439 * o + 21.882 * i)) +
            0.101 * Math.sin(yt * (13.1347 + 1331734.0404 * e + 58.906 * s + 17.971 * o - 8.566 * i)) +
            0.1 * Math.sin(yt * (358.0578 + 221744.8187 * e - 760.194 * s - 85.777 * o + 40.505 * i)) +
            0.087 * Math.sin(yt * (98.2661 + 449334.4057 * e - 124.107 * s - 10.643 * o + 5.028 * i)) +
            0.08 * Math.sin(yt * (42.948 + 1653341.4216 * e - 490.283 * s - 42.734 * o + 20.113 * i)) +
            0.08 * Math.sin(yt * (222.5657 - 441199.8173 * e - 91.506 * s - 14.307 * o + 6.797 * i)) +
            0.077 * Math.sin(yt * (294.0181 - 163726.0747 * e - 423.546 * s - 50.103 * o + 23.651 * i)) -
            0.073 * Math.sin(yt * (280.8834 - 1495460.1151 * e - 482.452 * s - 68.074 * o + 32.217 * i)) -
            0.071 * Math.sin(yt * (304.6819 + 1204007.0159 * e - 366.177 * s - 32.092 * o + 15.085 * i)) -
            0.069 * Math.sin(yt * (233.7582 + 1112279.0417 * e - 792.795 * s - 82.113 * o + 38.736 * i)) -
            0.067 * Math.sin(yt * (34.7551 + 249609.2807 * e - 546.117 * s - 60.787 * o + 28.679 * i)) -
            0.067 * Math.sin(yt * (263.6238 + 381403.5993 * e - 228.841 * s - 23.199 * o + 10.941 * i)) +
            0.055 * Math.sin(yt * (21.6203 - 1082124.7597 * e - 605.023 * s - 78.757 * o + 37.246 * i)) +
            0.055 * Math.sin(yt * (308.4192 - 489205.1674 * e + 158.029 * s + 14.915 * o - 7.029 * i)) -
            0.054 * Math.sin(yt * (8.7216 + 1589477.9094 * e - 702.824 * s - 67.766 * o + 31.939 * i)) -
            0.052 * Math.sin(yt * (179.8536 + 1908795.4705 * e + 359.881 * s + 57.39 * o - 27.189 * i)) -
            0.05 * Math.sin(yt * (98.7948 + 635080.1741 * e - 882.765 * s - 96.461 * o + 45.533 * i)) -
            0.049 * Math.sin(yt * (128.6604 - 95795.2683 * e - 318.812 * s - 37.547 * o + 17.738 * i)) -
            0.047 * Math.sin(yt * (17.3544 + 425341.6552 * e - 370.57 * s - 39.946 * o + 18.854 * i)) -
            0.044 * Math.sin(yt * (160.4159 + 4067.2942 * e - 107.806 * s - 12.475 * o + 5.913 * i)) -
            0.043 * Math.sin(yt * (238.1713 + 854535.1727 * e - 31.065 * s + 3.623 * o - 1.769 * i)) +
            0.042 * Math.sin(yt * (270.4555 + 1140143.5037 * e - 578.718 * s - 57.123 * o + 26.911 * i)) -
            0.042 * Math.sin(yt * (132.4925 + 513197.9179 * e + 88.434 * s + 14.388 * o - 6.797 * i)) -
            0.041 * Math.sin(yt * (122.3573 - 668789.4043 * e - 727.594 * s - 89.441 * o + 42.274 * i)) -
            0.04 * Math.sin(yt * (105.6788 + 341337.2548 * e - 119.499 * s - 10.765 * o + 5.028 * i)) +
            0.038 * Math.sin(yt * (135.4921 + 662944.6361 * e - 668.688 * s - 71.47 * o + 33.708 * i)) -
            0.037 * Math.sin(yt * (242.391 - 51857.2124 * e - 460.54 * s - 54.293 * o + 25.652 * i)) +
            0.036 * Math.sin(yt * (336.4374 + 1303869.5784 * e - 155.171 * s - 7.02 * o + 3.259 * i)) +
            0.035 * Math.sin(yt * (223.0943 - 255454.0489 * e - 850.164 * s - 100.124 * o + 47.302 * i)) -
            0.034 * Math.sin(yt * (193.2811 - 577061.4302 * e - 300.976 * s - 39.419 * o + 18.623 * i)) +
            0.031 * Math.sin(yt * (87.6023 - 918398.685 * e - 181.476 * s - 28.654 * o + 13.594 * i)),
          v = 2.4 * Math.sin(yt * (103.2 + 377336.3 * e)),
          M = 83.353 + 4069.0137 * e - 103.238 * s - 12.492 * o + 5.263 * i + g + 0.001 * e * v,
          b =
            -1.4979 * Math.sin(yt * (49.1562 - 75869.812 * e + 35.458 * s + 4.231 * o - 2.001 * i)) -
            0.15 * Math.sin(yt * (357.5291 + 35999.0503 * e - 1.536 * s + 0.041 * o + 0 * i)) -
            0.1226 * Math.sin(yt * (235.7004 + 890534.223 * e - 32.601 * s + 3.664 * o - 1.769 * i)) +
            0.1176 * Math.sin(yt * (186.5442 + 966404.0351 * e - 68.058 * s - 0.567 * o + 0.232 * i)) -
            0.0801 * Math.sin(yt * (83.3826 - 12006.2998 * e + 247.999 * s + 29.262 * o - 13.826 * i)) -
            0.0616 * Math.sin(yt * (51.6271 - 111868.8623 * e + 36.994 * s + 4.19 * o - 2.001 * i)) +
            0.049 * Math.sin(yt * (100.737 + 413335.3554 * e - 122.571 * s - 10.684 * o + 5.028 * i)) +
            0.0409 * Math.sin(yt * (308.4192 - 489205.1674 * e + 158.029 * s + 14.915 * o - 7.029 * i)) +
            0.0327 * Math.sin(yt * (134.9634 + 477198.8676 * e + 89.97 * s + 14.348 * o - 6.797 * i)) +
            0.0324 * Math.sin(yt * (46.6853 - 39870.7617 * e + 33.922 * s + 4.272 * o - 2.001 * i)) +
            0.0196 * Math.sin(yt * (98.3124 - 151739.624 * e + 70.916 * s + 8.462 * o - 4.001 * i)) +
            0.018 * Math.sin(yt * (274.1928 - 553068.6797 * e - 54.513 * s - 10.116 * o + 4.797 * i)) +
            0.015 * Math.sin(yt * (325.7736 - 63863.5122 * e - 212.541 * s - 25.031 * o + 11.826 * i)) -
            0.015 * Math.sin(yt * (184.1196 + 401329.0556 * e + 125.428 * s + 18.579 * o - 8.798 * i)) -
            0.0078 * Math.sin(yt * (238.1713 + 854535.1727 * e - 31.065 * s + 3.623 * o - 1.769 * i)) -
            0.0045 * Math.sin(yt * (10.6638 + 1367733.0907 * e + 57.37 * s + 18.011 * o - 8.566 * i)) +
            0.0044 * Math.sin(yt * (321.5076 + 1443602.9027 * e + 21.912 * s + 13.78 * o - 6.566 * i)) -
            0.0042 * Math.sin(yt * (162.8868 - 31931.7561 * e - 106.271 * s - 12.516 * o + 5.913 * i)) -
            0.0031 * Math.sin(yt * (170.9849 - 930404.9848 * e + 66.523 * s + 0.608 * o - 0.232 * i)) +
            0.0031 * Math.sin(yt * (103.2079 + 377336.3051 * e - 121.035 * s - 10.724 * o + 5.028 * i)) +
            0.0029 * Math.sin(yt * (222.612 - 1042273.8471 * e + 103.516 * s + 4.798 * o - 2.232 * i)) +
            0.0028 * Math.sin(yt * (184.0733 + 1002403.0853 * e - 69.594 * s - 0.526 * o + 0.232 * i)),
          w = 25.9 * Math.sin(yt * (125 - 1934.1 * e)) - 4.3 * Math.sin(yt * (220.2 - 1935.5 * e)),
          k = 0.38 * Math.sin(yt * (357.5 + 35999.1 * e)),
          x = 125.0446 - 1934.13618 * e + 20.762 * s + 2.139 * o - 1.65 * i + b + 0.001 * (w + k * e),
          z =
            -0.92581 * Math.sin(yt * (235.7004 + 890534.223 * e - 32.601 * s + 3.664 * o - 1.769 * i)) +
            0.33262 * Math.sin(yt * (100.737 + 413335.3554 * e - 122.571 * s - 10.684 * o + 5.028 * i)) -
            0.18402 * Math.sin(yt * (357.5291 + 35999.0503 * e - 1.536 * s + 0.041 * o + 0 * i)) +
            0.11007 * Math.sin(yt * (134.9634 + 477198.8676 * e + 89.97 * s + 14.348 * o - 6.797 * i)) -
            0.06055 * Math.sin(yt * (238.1713 + 854535.1727 * e - 31.065 * s + 3.623 * o - 1.769 * i)) +
            0.04741 * Math.sin(yt * (325.7736 - 63863.5122 * e - 212.541 * s - 25.031 * o + 11.826 * i)) -
            0.03086 * Math.sin(yt * (10.6638 + 1367733.0907 * e + 57.37 * s + 18.011 * o - 8.566 * i)) +
            0.02184 * Math.sin(yt * (103.2079 + 377336.3051 * e - 121.035 * s - 10.724 * o + 5.028 * i)) +
            0.01645 * Math.sin(yt * (49.1562 - 75869.812 * e + 35.458 * s + 4.231 * o - 2.001 * i)) +
            0.01022 * Math.sin(yt * (233.2295 + 926533.2733 * e - 34.136 * s + 3.705 * o - 1.769 * i)) -
            0.00756 * Math.sin(yt * (336.4374 + 1303869.5784 * e - 155.171 * s - 7.02 * o + 3.259 * i)) -
            0.0053 * Math.sin(yt * (222.5657 - 441199.8173 * e - 91.506 * s - 14.307 * o + 6.797 * i)) -
            0.00496 * Math.sin(yt * (162.8868 - 31931.7561 * e - 106.271 * s - 12.516 * o + 5.913 * i)) -
            0.00472 * Math.sin(yt * (297.8502 + 445267.1115 * e - 16.3 * s + 1.832 * o - 0.884 * i)) -
            0.00271 * Math.sin(yt * (240.6422 + 818536.1225 * e - 29.529 * s + 3.582 * o - 1.769 * i)) +
            0.00264 * Math.sin(yt * (132.4925 + 513197.9179 * e + 88.434 * s + 14.388 * o - 6.797 * i)) -
            0.00254 * Math.sin(yt * (186.5442 + 966404.0351 * e - 68.058 * s - 0.567 * o + 0.232 * i)) +
            0.00234 * Math.sin(yt * (269.9268 + 954397.7353 * e + 179.941 * s + 28.695 * o - 13.594 * i)) -
            0.0022 * Math.sin(yt * (13.1347 + 1331734.0404 * e + 58.906 * s + 17.971 * o - 8.566 * i)) -
            0.00202 * Math.sin(yt * (355.0582 + 71998.1006 * e - 3.072 * s + 0.082 * o + 0 * i)) +
            0.00167 * Math.sin(yt * (328.2445 - 99862.5625 * e - 211.005 * s - 25.072 * o + 11.826 * i)) -
            0.00143 * Math.sin(yt * (173.5506 + 1335801.3346 * e - 48.901 * s + 5.496 * o - 2.653 * i)) -
            0.00121 * Math.sin(yt * (98.2661 + 449334.4057 * e - 124.107 * s - 10.643 * o + 5.028 * i)) -
            0.00116 * Math.sin(yt * (145.6272 + 1844931.9583 * e + 147.34 * s + 32.359 * o - 15.363 * i)) +
            0.00102 * Math.sin(yt * (105.6788 + 341337.2548 * e - 119.499 * s - 10.765 * o + 5.028 * i)) -
            9e-4 * Math.sin(yt * (184.1196 + 401329.0556 * e + 125.428 * s + 18.579 * o - 8.798 * i)) -
            86e-5 * Math.sin(yt * (338.9083 + 1267870.5281 * e - 153.636 * s - 7.061 * o + 3.259 * i)) -
            78e-5 * Math.sin(yt * (111.4008 + 1781068.4461 * e - 65.201 * s + 7.328 * o - 3.538 * i)) +
            69e-5 * Math.sin(yt * (323.3027 - 27864.4619 * e - 214.077 * s - 24.99 * o + 11.826 * i)) +
            66e-5 * Math.sin(yt * (51.6271 - 111868.8623 * e + 36.994 * s + 4.19 * o - 2.001 * i)) +
            65e-5 * Math.sin(yt * (38.5872 + 858602.4669 * e - 138.871 * s - 8.852 * o + 4.144 * i)) -
            6e-4 * Math.sin(yt * (83.3826 - 12006.2998 * e + 247.999 * s + 29.262 * o - 13.826 * i)) +
            54e-5 * Math.sin(yt * (201.474 + 826670.7108 * e - 245.142 * s - 21.367 * o + 10.057 * i)) -
            52e-5 * Math.sin(yt * (308.4192 - 489205.1674 * e + 158.029 * s + 14.915 * o - 7.029 * i)) +
            48e-5 * Math.sin(yt * (8.1929 + 1403732.141 * e + 55.834 * s + 18.052 * o - 8.566 * i)) -
            41e-5 * Math.sin(yt * (46.6853 - 39870.7617 * e + 33.922 * s + 4.272 * o - 2.001 * i)) -
            33e-5 * Math.sin(yt * (274.1928 - 553068.6797 * e - 54.513 * s - 10.116 * o + 4.797 * i)) +
            3e-4 * Math.sin(yt * (160.4159 + 4067.2942 * e - 107.806 * s - 12.475 * o + 5.913 * i)),
          ...
          P = 218.31665 + 481267.88134 * e - 13.268 * s + 1.856 * o - 1.534 * i + z + 0.001 * (S + T * e + j * s);
        return (
          (t.a = d),
          (t.e = h),
          (t.i = 2 * Math.asin(y)),
      ...
      corr: function (t, e) {
        ...
        return (t.dec += i), (t.age = jt.normalize(t.l - e.l + Math.PI)), (t.phase = 0.5 * (1 - Math.cos(t.age))), t;
      },
    },
    Nt = d3.map({
  ...
  var Ht = function (t, e) {
    function a() {
      ...
      for (var o = 0; o < 7; o++) n.append('div').classed({ date: !0, weekday: !0 }).html(f[o]);
      for (o = 0; o < 42; o++) {
        var i = a.getMonth(),
          l = a.getDay(),
          c = m(a);
        ...
        -9999 === a.offsetTop
          ? (p.setTime(t.valueOf()),
            ...
            d3
              .select(J + ' ~ #celestial-form')
              .select('#celestial-date')
              .style({ top: M(s), left: M(r), opacity: 1 }),
            d3
              .select(J + ' ~ #celestial-form')
              .select('#datepick')
              .classed('active', !0))
  ...
  !(function () {
    ...
    function o(t) {
      return [
        Math.atan2(2 * (t[0] * t[1] + t[2] * t[3]), 1 - 2 * (t[1] * t[1] + t[2] * t[2])) * u,
        Math.asin(Math.max(-1, Math.min(1, 2 * (t[0] * t[2] - t[3] * t[1])))) * u,
        Math.atan2(2 * (t[0] * t[3] + t[1] * t[2]), 1 - 2 * (t[2] * t[2] + t[3] * t[3])) * u,
      ];
    }
    function i(t) {
      var e = t[0] * p,
    ...
    d3.geo.zoom = function () {
      ...
      return (
        ...
        (g.projection = function (t) {
          return arguments.length ? ((u = t), (M = { r: u.rotate(), k: u.scale() }), g.scale(M.k)) : u;
        }),
          ...
          t.each(function () {
            ...
            if (r !== t) {
              r.each('start.zoom', function () {
                this.__chart__ && ((M = this.__chart__), M.hasOwnProperty('r') || (M.r = u.rotate())),
                ...
                .tween('zoom:zoom', function () {
                  ...
                  return (
                    ...
                    function (a) {
                      var n = d(a);
                      (this.__chart__ = M = { r: o(i(n[0] / l)), k: t / n[2] }),
                        u.rotate(M.r).scale(M.k),
                        g.scale(M.k),
                        c(e);
                    }
      ...
      function r(t, e) {
        return function (n, r) {
          t._tasks[e] &&
            ...
            ++t._ended,
            (t._tasks[e] = null),
            null == t._error && (null != n ? s(t, n) : ((t._data[e] = r), t._waiting ? a(t) : o(t))));
        };
      }
      function s(t, e) {
        var a,
