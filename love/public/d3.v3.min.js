!(function () {
    ...
    return (
      (t.on = function (t, i) {
        ...
        return arguments.length < 2
          ? o && o.on
          : (o && ((o.on = null), (e = e.slice(0, (u = e.indexOf(o))).concat(e.slice(u + 1))), r.remove(t)),
  ...
  function J(n, e) {
    ...
    if (r.createSVGPoint) {
      ...
      return (
        Po ? ((i.x = e.pageX), (i.y = e.pageY)) : ((i.x = e.clientX), (i.y = e.clientY)),
  ...
  function Cn(n, t, e, r) {
    ...
    return (
      ...
      (u.header = function (n, t) {
        return (
          (n = (n + '').toLowerCase()), arguments.length < 2 ? a[n] : (null == t ? delete a[n] : (a[n] = t + ''), u)
        );
      }),
        ...
        r && e
          ? function (n, t) {
              for (
                ...
                i > 0 &&
                a > 0 &&
                (l + a + 1 > t && (a = Math.max(1, t - l)), u.push(n.substring((i -= a), i + a)), !((l += a + 1) > t));
        ...
        m = {
          ...
          polygonEnd: function () {
            ...
            p.length
              ...
              : n && (b || (u.polygonStart(), (b = !0)), u.lineStart(), e(null, null, 1, u), u.lineEnd()),
              b && (u.polygonEnd(), (b = !1)),
              (p = g = null);
          },
          sphere: function () {
  ...
  function Ft(n, t, e, r) {
    ...
    return xo(o) > Uo
      ? Math.atan(
          (Math.sin(t) * (u = Math.cos(r)) * Math.sin(e) - Math.sin(r) * (i = Math.cos(t)) * Math.sin(n)) / (i * u * o),
        )
      : (t + r) / 2;
  }
  function Ht(n, t, e, r) {
    ...
    function e(n) {
      ...
      return {
        ...
        point: function (s, h) {
          ...
          if (
            (!e && (c = l = v) && n.lineStart(),
            v !== l && ((p = r(e, g)), (wt(e, p) || wt(g, p)) && ((g[0] += Uo), (g[1] += Uo), (v = t(g[0], g[1])))),
            v !== l)
          )
            (f = 0),
              v
        ...
        if (((u = e - l), g || !(0 > u))) {
          ...
          if (((u = t - c), v || !(u > 0))) {
            ...
            if (((u = r - c), v || !(0 > u))) {
              ...
              return (
                h > 0 && (i.a = { x: l + h * g, y: c + h * v }), 1 > p && (i.b = { x: l + p * g, y: c + p * v }), i
              );
            }
          }
        }
  ...
  function ae(n) {
    ...
    return (
      ...
      (t.rotate = function (n) {
        return arguments.length
          ? ((y = (n[0] % 360) * Yo), (M = (n[1] % 360) * Yo), (x = n.length > 2 ? (n[2] % 360) * Yo : 0), r())
          : [y * Zo, M * Zo, x * Zo];
      }),
  ...
  function ve(n, t) {
    ...
    return function (i, u, o, a) {
      var l = o * t;
      null != i
        ? ((i = de(e, i)), (u = de(e, u)), (o > 0 ? u > i : i > u) && (i += o * Ho))
        : ((i = n + o * Ho), (u = n - 0.5 * l));
  ...
  function Ze(n) {
    for (
      var t, e, r, i, u, o, a, l, c, f, s = n[0][0], h = n[1][0], p = n[0][1], g = n[1][1], v = ul, d = v.length;
      d--;
  ...
  function We(n) {
    for (var t, e = il, r = Yt(n[0][0], n[0][1], n[1][0], n[1][1]), i = e.length; i--; )
      (t = e[i]),
        (!Je(t, n) || !r(t) || (xo(t.a.x - t.b.x) < Uo && xo(t.a.y - t.b.y) < Uo)) &&
    ...
    return (
      (function c(n, f, s, h, p) {
        if (!(f > u || s > o || r > h || i > p)) {
          ...
          for (
            var M = n.nodes, x = 0.5 * (f + h), b = 0.5 * (s + p), _ = t >= x, w = e >= b, S = (w << 1) | _, k = S + 4;
            k > S;
            ++S
          )
            if ((n = M[3 & S]))
  ...
  function oi(n, t) {
    for (var e = [n], r = []; null != (n = e.pop()); )
      if ((r.push(n), (u = n.children) && (i = u.length))) for (var i, u, o = -1; ++o < i; ) e.push(u[o]);
  ...
  function au(n, t) {
    ...
    return (
      ...
      (o.invertExtent = function (e) {
        return (
          (e = t.indexOf(e)), 0 > e ? [NaN, NaN] : [e > 0 ? a[e - 1] : n[0], e < a.length ? a[e] : n[n.length - 1]]
        );
      }),
      (o.copy = function () {
        return au(n, t);
  ...
  function Au(n, t) {
    ...
    if (
      (e &&
        ((r += 'Q' + (u[0] - (2 * o[0]) / 3) + ',' + (u[1] - (2 * o[1]) / 3) + ',' + u[0] + ',' + u[1]),
        (i = n[1]),
        (l = 2)),
      t.length > 1)
    ) {
  ...
  function Qu(n, t, e, r, i) {
    ...
    function a(i) {
      ...
      return u >= 1
        ? (v.event && v.event.end.call(n, n.__data__, t), --g.count ? delete g[r] : delete n[e], 1)
        : void 0;
    }
    var l,
      f,
    ...
    v ||
      ((l = i.time),
      (f = qn(u, 0, l)),
      (v = g[r] = { tween: new c(), time: l, timer: f, delay: i.delay, duration: i.duration, ease: i.ease, index: t }),
      (i = null),
      ++g.count);
  }
  function no(n, t, e) {
  ...
  (Co.select = function (n) {
    ...
    for (var o = -1, a = this.length; ++o < a; ) {
      ...
      for (var l = -1, c = r.length; ++l < c; )
        (i = r[l])
          ? (t.push((e = n.call(i, i.__data__, l, o))), e && '__data__' in i && (e.__data__ = i.__data__))
          : t.push(null);
    }
    return E(u);
  }),
    ...
    (Co.data = function (n, t) {
      function e(n, e) {
        ...
        if (t) {
          ...
          for (r = -1; ++r < s; )
            (i = y.get((d = t.call(e, (u = e[r]), r)))) ? i !== !0 && ((p[r] = i), (i.__data__ = u)) : (g[r] = H(u)),
              y.set(d, !0);
    ...
    (qo.select = function (n) {
      for (var t, e, r, i, u, o = [], a = -1, l = this.length; ++a < l; ) {
        ...
        for (var c = -1, f = i.length; ++c < f; )
          (u = i[c])
            ? (t.push((r[c] = e = n.call(i.parentNode, u.__data__, c, a))), (e.__data__ = u.__data__))
            : t.push(null);
      }
      return E(o);
    }),
  ...
  (ao.touch = function (n, t, e) {
    if ((arguments.length < 3 && ((e = t), (t = k().changedTouches)), t))
      for (var r, i = 0, u = t.length; u > i; ++i) if ((r = t[i]).identifier === e) return J(n, r);
  }),
        ...
        (e.parseRows = function (n, t) {
          function e() {
            ...
            if (34 === n.charCodeAt(t)) {
              ...
              return (
                13 === r ? ((i = !0), 10 === n.charCodeAt(e + 2) && ++f) : 10 === r && (i = !0),
  ...
  (ao.geo.bounds = (function () {
    ...
    return function (n) {
      ...
      if (t) {
        ...
        for (var e, r = 1, i = M[0], u = [i]; t > r; ++r)
          (e = M[r]),
            c(e[0], i) || c(e[1], i)
              ? (a(i[0], e[1]) > a(i[0], i[1]) && (i[1] = e[1]), a(e[0], i[1]) > a(i[0], i[1]) && (i[0] = e[0]))
              : u.push((i = e));
    ...
    (ao.geo.centroid = function (n) {
      ...
      var t = Da,
        ...
        i = t * t + e * e + r * r;
      return jo > i &&
        ((t = qa), (e = Ta), (r = Ra), Uo > Aa && ((t = Ca), (e = za), (r = La)), (i = t * t + e * e + r * r), jo > i)
        ? [NaN, NaN]
  ...
  (ao.geo.path = function () {
    ...
    return (
      ...
      (n.context = function (n) {
        return arguments.length
          ? ((u = null == (r = n) ? new Wt() : new te(n)), 'function' != typeof a && u.pointRadius(a), t())
          : r;
      }),
    ...
    (ao.geo.graticule = function () {
      ...
      return (
        ...
        (n.precision = function (t) {
          return arguments.length
            ? ((m = +t), (f = ye(a, o, 90)), (s = me(r, e, m)), (h = ye(c, l, 90)), (p = me(u, i, m)), n)
            : m;
        }),
        n
          .majorExtent([
          ...
          (r = e.U),
            e === r.L
              ? ((i = r.R),
                i && i.C
                  ? ((e.C = i.C = !1), (r.C = !0), (n = r))
                  : (n === e.R && (ir(this, e), (n = e), (e = n.U)), (e.C = !1), (r.C = !0), ur(this, r)))
              : ((i = r.L),
                i && i.C
                  ? ((e.C = i.C = !1), (r.C = !0), (n = r))
                  : (n === e.L && (ur(this, e), (n = e), (e = n.U)), (e.C = !1), (r.C = !0), ir(this, r))),
            (e = n.U);
        this._.C = !1;
      },
      remove: function (n) {
        ...
        if (
          ...
          do {
            ...
            if (n === i.L) {
              if (
                ((t = i.R), t.C && ((t.C = !1), (i.C = !0), ir(this, i), (t = i.R)), (t.L && t.L.C) || (t.R && t.R.C))
              ) {
              ...
              ((t = i.L), t.C && ((t.C = !1), (i.C = !0), ur(this, i), (t = i.L)), (t.L && t.L.C) || (t.R && t.R.C))
            ) {
  ...
  (ao.ease = function (n) {
    ...
    (jr.prototype.toString = function () {
      return (
        'translate(' + this.translate + ')rotate(' + this.rotate + ')skewX(' + this.skew + ')scale(' + this.scale + ')'
      );
    });
    ...
    (ao.layout.force = function () {
      ...
      return (
        ...
        (l.drag = function () {
          return (
            r ||
              (r = ao.behavior.drag().origin(m).on('dragstart.force', Qr).on('drag.force', t).on('dragend.force', ni)),
  ...
  (ao.layout.histogram = function () {
    ...
    (ao.layout.tree = function () {
      ...
      function i(n, t, e) {
        if (t) {
          for (
            var r, i = n, u = n, o = t, l = i.parent.children[0], c = i.m, f = u.m, s = o.m, h = l.m;
            (o = Ti(o)), (i = qi(i)), o && i;
    ...
    (ao.layout.treemap = function () {
      ...
      return (
        ...
        (u.padding = function (n) {
          ...
          return (
            (s =
              null == (f = n) ? Oi : 'function' == (r = typeof n) ? t : 'number' === r ? ((n = [n, n, n, n]), e) : e),
            u
          );
        }),
        (u.round = function (n) {
  ...
  var Al = [2062260, 16744206, 2924588, 14034728, 9725885, 9197131, 14907330, 8355711, 12369186, 1556175].map(xn),
    ...
    zl = [
      3750777, 5395619, 7040719, 10264286, 6519097, 9216594, 11915115, 13556636, 9202993, 12426809, 15186514, 15190932,
      8666169, 11356490, 14049643, 15177372, 8077683, 10834324, 13528509, 14589654,
    ].map(xn),
    Ll = [
      ...
      function n() {
        ...
        if (
          ((y = (+l.apply(this, arguments) || 0) / 2) &&
            ((d = u === ql ? Math.sqrt(n * n + c * c) : +u.apply(this, arguments)),
            p || (E *= -1),
      ...
      for (var a = -1, l = this.length; ++a < l; ) {
        ...
        for (var c = this[a], f = -1, s = c.length; ++f < s; )
          (r = c[f]) && (e = n.call(r, r.__data__, f, a))
            ? ('__data__' in r && (e.__data__ = r.__data__), Qu(e, f, u, i, r[u][i]), t.push(e))
            : t.push(null);
      }
      return Wu(o, u, i);
    }),
    ...
    (Yl.transition = function () {
      for (var n, t, e, r, i = this.id, u = ++Zl, o = this.namespace, a = [], l = 0, c = this.length; c > l; l++) {
        ...
        for (var t = this[l], f = 0, s = t.length; s > f; f++)
          (e = t[f]) &&
            ((r = e[o][i]),
            Qu(e, f, o, u, { time: r.time, ease: r.ease, delay: r.delay + r.duration, duration: r.duration })),
            n.push(e);
      }
      return Wu(a, o, u);
    }),
    ...
    function u() {
      ...
      function y(n, t, e) {
        ...
        return (
          ...
          C
            ? (i = (r += f) + d)
            : (M && (f = Math.max(l, Math.min(c, 2 * M[e] - r))), r > f ? ((i = r), (r = f)) : (i = f)),
