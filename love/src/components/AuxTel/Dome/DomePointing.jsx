  ...
  render() {
    ...
    return (
      <svg
        ...
        viewBox="0 0 596 596"
        style={{
          transform: `translate(-50%,-50%) rotateY(${-90+el}deg) rotate3d(${Math.cos(el*Math.PI/180)}, 0, ${Math.sin(el*Math.PI/180)},${-90+az}deg) scale(0.5)`,
      ...
      >
        <line
          ...
          strokeDasharray="5"
        />
        <circle r={64} stroke="white" strokeWidth={2} cx={currentPixels.x} cy={currentPixels.y} fill="red" />
