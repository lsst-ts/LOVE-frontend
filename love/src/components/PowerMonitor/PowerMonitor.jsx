...
function PowerMonitor({
  ...
  const hoveredMainGenerator = hoveredDevices.length > 0 ? hoveredDevices.includes('MAIN_GENERATOR') : null;
  const hoveredSlaveGenerator = hoveredDevices.length > 0 ? hoveredDevices.includes('SLAVE_GENERATOR') : null;
      ...
      <div className={styles.container}>
        <div className={styles.section}>
          ...
          <GeneratorCard
            ...
            hovered={hoveredMainGenerator}
            onMouseEnter={() => setHoveredDevices(DEVICE_HOVER_GROUP.MAIN_GENERATOR)}
            onMouseLeave={handleDeviceMouseLeave}
          />
          <GeneratorCard
            ...
            hovered={hoveredSlaveGenerator}
            onMouseEnter={() => setHoveredDevices(DEVICE_HOVER_GROUP.SLAVE_GENERATOR)}
            onMouseLeave={handleDeviceMouseLeave}
          />
        </div>
        <div className={styles.section}>
