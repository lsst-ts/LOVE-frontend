...
function LoadCard({ status, title, label, power, criticality, usage, voltageStdDev, conditions }) {
...
LoadCard.propTypes = {
  ...
  /** The criticality level of the load (i.e. "HIGH", "MEDIUM", "LOW") */
  criticality: PropTypes.string,
  /** The usage percentage of the load (0-100) */
  usage: PropTypes.number,
  /** The standard deviation of the voltage, in V, used to assess stability */
