...
UPSCard.propTypes = {
  ...
  /** The input voltage of the UPS. */
  inputVoltage: PropTypes.number,
  /** The input frequency of the UPS. */
  inputFrequency: PropTypes.number,
  /** The output voltage of the UPS. */
  outputVoltage: PropTypes.number,
  /** The output frequency of the UPS. */
  outputFrequency: PropTypes.number,
  /** The power being drawn from the UPS. */
  power: PropTypes.number,
  /** The load percentage of the UPS. */
  load: PropTypes.number,
  /** The battery percentage of the UPS. */
