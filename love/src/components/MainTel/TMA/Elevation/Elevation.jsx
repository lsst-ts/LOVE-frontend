...
export default class Elevation extends Component {
  static propTypes = {
    ...
    /** Elevation position */
    elevationPosition: PropTypes.number,
  };
  ...
  componentDidUpdate(prevProps) {
    if (prevProps.elevationPosition !== this.props.elevationPosition)
      this.prevElevation = this.closestEquivalentAngle(this.prevElevation, prevProps.elevationPosition);
  }
  ...
  render() {
    ...
    const offset = 10;
    const viewBoxSize = 502 - 2 * offset;
    ...
    const equivalentElevation = this.closestEquivalentAngle(this.prevAElevation, this.props.elevationPosition);
    return (
