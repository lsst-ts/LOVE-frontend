...
export default class Limits extends Component {
  ...
  render() {
    ...
    return (
        ...
        {/* Cartoon background */}   
        <circle
          r={`${radiusBack}`} cx={`${radius}`} cy={`${radius}`} className={styles.bg}
        />
        ...
        >
          ...
          >
            <tspan
              transition=" transform 1.5s linear 0s"
              className={[(currentText_X<0) ? [(currentText_Y<0)?styles.textQ4:styles.textQ3] : [(currentText_Y<1)?styles.textQ1:styles.textQ2]].join(' ')}
            >
              {`${currentValue+"º"}`}
            </tspan>
          </text>
        ...
        <g transform-origin="50% 50%" transform={`${"rotate("+rotationOffset+")"}`} >
          ...
          {/* Target background */} 
          <circle
            r={`${radiusBack/2}`} cx={`${radius}`} cy={`${radius}`} className={styles.bgTarget}
          ...
          <circle
            ...
            r={`${radiusBack/2}`} cx={`${radius}`} cy={`${radius}`} className={styles.bgCurrent}
            stroke-width={`${radiusBack}`}
        ...
        <g
          transform={`${"rotate("+rotationOffset+") scale(1 -1)"}`}
        ...
        <g className={styles.clipPathPos}>
          ...
          >
             ...
             {/* L3 Gauge */}   
             <circle
              r={`${radius}`} cx={`${radius}`} cy={`${radius}`} className={styles.gaugeL3}
             />

             {/* L2 Gauge */} 
             <circle
              r={`${radius/2}`} cx={`${radius}`} cy={`${radius}`} className={styles.gaugeL2}
             ...
             {/* L1 Gauge */} 
             <circle
              r={`${radius/2}`} cx={`${radius}`} cy={`${radius}`} className={styles.gaugeL1}
              stroke-width={`${radius/10}`}
          ...
          {/* Front Mask */}
          <circle
            r={`${radiusBack*0.8}`} cx={`${radius}`} cy={`${radius}`} className={styles.cutOut}
          />
