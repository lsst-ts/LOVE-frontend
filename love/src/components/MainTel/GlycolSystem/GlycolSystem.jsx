...
const telemetriesMapping = {
  ...
  'CRAC 1': {
    flow: 'glycolCRAC01flow',
    tempIn: 'glycolCRAC01temperatureIn',
    tempOut: 'glycolCRAC01temperatureOut',
    pressIn: 'glycolCRAC01pressureIn',
    pressOut: 'glycolCRAC01pressureOut',
  },
  'CRAC 2': {
    flow: 'glycolCRAC02flow',
    tempIn: 'glycolCRAC02temperatureIn',
    tempOut: 'glycolCRAC02temperatureOut',
    pressIn: 'glycolCRAC02pressureIn',
    pressOut: 'glycolCRAC02pressureOut',
  },
  'AHU CR': {
...
const devicesQuerySelectorMapping = {
  ...
  'CRAC 1': '#Building #computer-room',
  'CRAC 2': '#Building #computer-room',
