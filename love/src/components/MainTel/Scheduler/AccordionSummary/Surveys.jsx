...
export default class Surveys extends Component {
    ...
    render() {
        const generalProposals = ['63-EFD', '95ONES', 'AB987', 'DR-2345', 'GP-0002', 'GP-0167', 'OC124', 'TP0001', 'Q24', 'Z_DD01'];
        const timedProposals = ['429-FV', '766WF', '90.09.09', '975FG', 'Abs-01', 'DDW', 'DDW2', 'fav09', 'HI-00', 'LO-PQQ', 'LO-X01', 'W749-a', 'WF'];
