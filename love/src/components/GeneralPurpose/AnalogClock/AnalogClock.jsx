...
const renderMarkers = () => {
  ...
  for (let i = 0; i < 60; i++) {
    ...
    const className = i % 5 ? null : styles.heavyMarker;
    markers.push(
      <line x1={19 - (i % 5 ? shortLength : longLength)} y1="0" x2="19" y2="0" transform={`rotate(${angle}, 0, 0)`} className={className}/>
    );

    // if (i % 15 === 0) {
    //   markers.push(
    //     <text className={[styles.number].join(' ')}> {i / 15 * 3} </text>
    //   );
    // }
  }
  return markers;
...
export default function AnalogClock ({ timestamp }) {
  ...
  //         </g>
  //       </g>
  //       <line className={styles.second} x1="211.9" y1="107.4" x2="98.5" y2="119.3"/>
  //       <line className={styles.hour} x1="76.6" y1="166.2" x2="113.4" y2="119.5"/>
  //       <line className={styles.minute} x1="137.2" y1="29.5" x2="114.7" y2="116.6"/>
