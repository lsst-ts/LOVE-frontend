...
export const uifIndex = {
  ...
  VegaTimeseriesPlot: {
    component: require('../GeneralPurpose/TimeSeriesPlot/VegaTimeSeriesPlot.container').default,
    schema: require('../GeneralPurpose/TimeSeriesPlot/VegaTimeSeriesPlot.container').schema,
  },
  // TelemetryLog: {
