    ...
    return (
      ...
      >
        {this.props.unmuted ? (
          <>
            <path
              d="M16.59,8.23a4.83,4.83,0,0,0-2.84-.93.35.35,0,0,0-.35.35.35.35,0,0,0,.35.34,4.09,4.09,0,0,1,2.34.74l.54.44a4.12,4.12,0,0,1-2.88,7.06.35.35,0,1,0,0,.7,4.82,4.82,0,0,0,3.37-8.25Z"
              transform="translate(0 0)"
            />
            <path
              d="M14.8,10a2.3,2.3,0,0,0-1.05-.26.35.35,0,1,0,0,.7,1.77,1.77,0,0,1,.52.08l.62.37a1.65,1.65,0,0,1,.52,1.2,1.66,1.66,0,0,1-1.66,1.66.35.35,0,0,0-.35.35.35.35,0,0,0,.35.34,2.35,2.35,0,0,0,1.63-4Z"
              transform="translate(0 0)"
            />
            <path
