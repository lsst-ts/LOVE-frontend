...
function SaveNewIcon(props) {
  return (
    <svg viewBox="0 0 25.5 25.5" x="0px" y="0px" className={styles.svg}>
      <path className={styles.st0} d="M17.9,1c-3.3,0-6,2.7-6,6s2.7,6,6,6s6-2.7,6-6S21.2,1,17.9,1z M21.1,7.9h-2.5v2.5h-1.5V7.9h-2.5V6.5h2.5V4.1
        h1.5v2.4h2.5V7.9z"/>
      <path className={styles.st0} d="M10.9,7c0-0.2,0-0.3,0-0.5c-0.2,0-0.4,0.2-0.4,0.4v2.7c0,0.2,0.2,0.4,0.4,0.4h0.6C11.2,9.2,10.9,8.1,10.9,7z"
        />
      <path className={styles.st0} d="M17.9,14c-2,0-3.7-0.8-5-2.1H7.4c0,0,0,0,0,0c-0.2,0-0.4-0.2-0.4-0.5V6.9c0-0.2-0.2-0.5-0.5-0.5H3.4
