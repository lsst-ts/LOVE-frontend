  ...
  return (
    <svg className={styles.svg} viewBox="0 0 54.79 54.79" {...props}>
      <path
        ...
        d="M14.67,8.4l3.35,5.11c0.55-0.37,1.1-0.67,1.64-0.97l-2.74-5.48C16.19,7.49,15.4,7.91,14.67,8.4z"
      />
      <path
        className={styles.none}
        d="M31.41,24.54c-0.67-0.55-1.46-0.97-2.25-1.22c-0.61-1.03-1.16-7.79-1.77-7.79s-1.22,6.88-1.77,7.79
      ...
      <path
        className={styles.none}
        d="M35.07,12.66c0.55,0.3,1.1,0.61,1.64,0.97l3.35-5.11c-0.73-0.49-1.46-0.91-2.25-1.28L35.07,12.66z"
      />
      <path
        className={styles.none}
        d="M28.37,10.84l0.37-6.15c-0.85-0.06-1.7-0.06-2.5,0h-0.06l0.37,6.15C27.09,10.78,27.76,10.78,28.37,10.84z"
      />
      <path
        className={styles.none}
        d="M6.7,17.29l5.48,2.8c0.3-0.55,0.61-1.1,0.97-1.64l-5.11-3.41C7.49,15.77,7.06,16.5,6.7,17.29z"
      />
      <path
        className={styles.none}
        d="M4.2,26.42c-0.06,0.85-0.06,1.7,0,2.56v0.06l6.15-0.37c0-0.61,0-1.28,0-1.89L4.2,26.42z"
      />
      <path
        className={styles.none}
        d="M50.47,26.67v-0.06l-6.09,0.37c0.06,0.67,0,1.28,0,1.89l6.15,0.37C50.53,28.43,50.53,27.58,50.47,26.67z"
      />
      <path
        className={styles.none}
        d="M46.76,15.22l-5.11,3.35c0.37,0.55,0.67,1.1,0.97,1.64l5.48-2.74C47.67,16.68,47.24,15.89,46.76,15.22z"
      />
      <path
        className={styles.path}
        d="M27.4,54.79c9.11,0,17.21-4.48,22.15-11.29c0.27-0.37-0.01-0.89-0.46-0.89H5.66c-0.46,0-0.73,0.52-0.46,0.89
          C10.19,50.32,18.23,54.79,27.4,54.79z"
      />
      <path
        className={styles.path}
        d="M51.56,38.72c0.49,0,0.94-0.29,1.12-0.74c1.34-3.27,2.11-6.85,2.11-10.58C54.79,12.24,42.56,0,27.4,0
