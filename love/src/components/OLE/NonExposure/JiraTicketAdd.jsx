...
function JiraTicketAdd() {
  ...
  const renderSymptomField = () => {
    const inputError = tryingToSave && !log?.symptomMessage?.trim();
    return (
  ...
  const renderContextField = () => {
    const inputError = tryingToSave && !log?.contextMessage?.trim();
    return (
      <div className={styles.messageGroup}>
  ...
  const renderRecoveryField = () => {
    const inputError = tryingToSave && !log?.recoveryMessage?.trim();
    return (
      <div className={styles.messageGroup}>
