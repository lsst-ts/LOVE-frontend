...
export default class Level6 extends Component {
  ...
  <g id="Level6">
    ...
    <g>
      ...
      <polyline className={styles.cls7} points="210.84 50.65 420.7 115.16 463.4 115.16 461.22 152.09 468.01 259.86 470.08 268.12"/>
      ...
      <polyline className={styles.cls7} points="293.03 130.28 428.47 130.28 428.47 260.72 425.4 260.72 425.4 133.35 294.43 133.35"/>
    ...
    <path className={styles.cls18} d="m331.72,98.15c.19.06.38-.05.44-.23l2.84-9.2c.06-.19-.05-.38-.23-.44l-.1-.03c-.19-.06-.38.05-.44.23l-2.73,8.85c-4.59-1.73-7.05-6.71-5.6-11.42.06-.19-.05-.38-.23-.44s-.38.05-.44.23c-1.59,5.13,1.14,10.57,6.19,12.37.04.01.08.02.12.02.03,0,.05.04.08.05l.1.03h0Z"/>
    <rect className={styles.cls13} x="300.8" y="103.95" width="12.14" height="12.05"/>
    <g id="Machines">
      <rect className={styles.cls9} x="201.64" y="74.42" width="21.05" height="19.23" transform="translate(371.8 247.09) rotate(-156)"/>
    </g>
    <g id="Dome">
      <g>
      ...
      <g id="Walls">
        <polygon className={styles.cls7} points="178.61 88.14 133.77 88.14 133.77 61.07 190.52 61.07 190.52 62.37 135.08 62.37 135.08 86.51 178.56 86.51 178.61 88.14"/>
        <polygon className={styles.cls7} points="177.79 88.19 222.61 108.23 234.69 80.94 190.52 61.07 189.99 62.26 232.97 81.6 222.08 106.22 178.56 86.51 177.79 88.19"/>
        <rect className={styles.cls7} x="199.55" y="67.73" width="1.3" height="28.25" transform="translate(349.79 238.05) rotate(-156)"/>
        <rect className={styles.cls7} x="145.76" y="73.36" width="32.72" height="2.06"/>
      </g>
      <g id="Stairs">
        <polygon className={styles.cls13} points="144.96 76.14 144.96 72.81 175.57 72.81 175.57 63.13 135.84 63.13 135.84 68.47 135.84 72.81 135.84 76.14 135.84 85.83 144.96 85.83 178.52 85.83 178.52 76.14 144.96 76.14"/>
    ...
    <g id="text">
      <g id="t1">
        <g class="cls-27">
          <text className={styles.cls19} transform="translate(155.37 149.4)"><tspan className={styles.cls14} x="0" y="0">P</tspan><tspan x="4.17" y="0">ier</tspan><tspan x="-22.22" y="7.2">In</tspan><tspan className={styles.cls28} x="-16.35" y="7.2">t</tspan><tspan x="-14.03" y="7.2">e</tspan><tspan className={styles.cls24} x="-10.4" y="7.2">r</tspan><tspan className={styles.cls23} x="-8.05" y="7.2">m</tspan><tspan x="-1.67" y="7.2">edia</tspan><tspan className={styles.cls3} x="11.18" y="7.2">t</tspan><tspan className={styles.cls22} x="13.5" y="7.2">e Floor</tspan></text>
          <text className={styles.cls19} transform="translate(155.37 149.4)"><tspan className={styles.cls14} x="0" y="0">P</tspan><tspan x="4.17" y="0">ier</tspan><tspan x="-22.22" y="7.2">In</tspan><tspan className={styles.cls28} x="-16.35" y="7.2">t</tspan><tspan x="-14.03" y="7.2">e</tspan><tspan className={styles.cls24} x="-10.4" y="7.2">r</tspan><tspan className={styles.cls23} x="-8.05" y="7.2">m</tspan><tspan x="-1.67" y="7.2">edia</tspan><tspan className={styles.cls3} x="11.18" y="7.2">t</tspan><tspan className={styles.cls22} x="13.5" y="7.2">e Floor</tspan></text>
        </g>
      </g>
      <g id="t2" className={styles.cls25}>
        <g class="cls-27">
          <text className={styles.cls20} transform="translate(340.05 76.62)"><tspan x="0" y="0">Roof</tspan></text>
          <text className={styles.cls20} transform="translate(340.05 76.62)"><tspan x="0" y="0">Roof</tspan></text>
        </g>
        <g class="cls-27">
          <text className={styles.cls20} transform="translate(212.71 193.75)"><tspan x="0" y="0">Ha</tspan><tspan className={styles.cls2} x="5.61" y="0">t</tspan><tspan className={styles.cls26} x="7.16" y="0">c</tspan><tspan x="9.38" y="0">h</tspan></text>
          <text className={styles.cls20} transform="translate(212.71 193.75)"><tspan x="0" y="0">Ha</tspan><tspan className={styles.cls2} x="5.61" y="0">t</tspan><tspan className={styles.cls26} x="7.16" y="0">c</tspan><tspan x="9.38" y="0">h</tspan></text>
        </g>
        <g class="cls-27">
          <text className={styles.cls20} transform="translate(206.67 84.73)"><tspan x="0" y="0">El</tspan><tspan className={styles.cls1} x="3.75" y="0">e</tspan><tspan className={styles.cls15} x="6.13" y="0">v</tspan><tspan x="8.16" y="0">. 3</tspan></text>
          <text className={styles.cls20} transform="translate(206.67 84.73)"><tspan x="0" y="0">El</tspan><tspan className={styles.cls1} x="3.75" y="0">e</tspan><tspan className={styles.cls15} x="6.13" y="0">v</tspan><tspan x="8.16" y="0">. 3</tspan></text>
        </g>
        <g class="cls-27">
          <text className={styles.cls20} transform="translate(300.74 111.41)"><tspan x="0" y="0">Ha</tspan><tspan className={styles.cls2} x="5.61" y="0">t</tspan><tspan className={styles.cls26} x="7.16" y="0">c</tspan><tspan x="9.38" y="0">h</tspan></text>
          <text className={styles.cls20} transform="translate(300.74 111.41)"><tspan x="0" y="0">Ha</tspan><tspan className={styles.cls2} x="5.61" y="0">t</tspan><tspan className={styles.cls26} x="7.16" y="0">c</tspan><tspan x="9.38" y="0">h</tspan></text>
        </g>
      </g>
    </g>
