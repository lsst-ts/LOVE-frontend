  ...
  <g id="Level4">
    <g id="Building">
      ...
      <g id="Wall">
        ...
        <polygon className={styles.cls7} points="766.91 114.42 768.31 114.42 768.31 116.99 838.94 116.99 838.94 118.39 766.91 118.39 766.91 114.42"/>
        <rect className={styles.cls7} x="277.24" y="54.53" width="1.4" height="6.58" transform="translate(335.76 -220.13) rotate(90)"/>
        <rect className={styles.cls7} x="292.99" y="55.15" width="1.4" height="5.34" transform="translate(351.51 -235.88) rotate(90)"/>
        ...
        <rect className={styles.cls7} x="294.82" y="71.52" width="1.4" height="41.28" transform="translate(191.19 -199.29) rotate(52.98)"/>
        ...
        <polygon className={styles.cls7} points="429.63 59.51 337.63 59.51 337.63 59.53 327.32 67.31 328.16 68.43 338.12 60.91 429.63 60.91 429.63 59.51"/>
        <rect className={styles.cls7} x="252.82" y="37.81" width="1.4" height="6.58" transform="translate(507.04 82.19) rotate(180)"/>
        <line className={styles.cls7} x1="273.89" y1="44.09" x2="254.29" y2="44.09"/>
      </g>
      <g id="DOORS">
        <path className={styles.cls16} d="m801.1,113.05c-.2,0-.35-.16-.35-.35v-9.63c0-.2.16-.35.35-.35h.1c.2,0,.35.16.35.35v9.26c4.9-.3,8.72-4.33,8.72-9.26,0-.2.16-.35.35-.35s.35.16.35.35c0,5.37-4.21,9.76-9.57,9.99-.04,0-.08,0-.12-.02-.03,0-.06.02-.09.02h-.1.01Z"/>
        <path className={styles.cls16} d="m778.38,105.27c0-.2-.16-.35-.35-.35h-9.63c-.2,0-.35.16-.35.35v.1c0,.2.16.35.35.35h9.26c-.3,4.9-4.33,8.72-9.26,8.72-.2,0-.35.16-.35.35s.16.35.35.35c5.37,0,9.76-4.21,9.99-9.57,0-.04,0-.08-.02-.12,0-.03.02-.06.02-.09v-.1h-.01Z"/>
        <path className={styles.cls16} d="m321.92,61.12l-.16.12s-.04.03-.05.05c-3.26,2.75-4.28,7.19-2.76,10.98-3.26-2.55-7.87-2.8-11.45-.36-.02.02-.03.05-.05.07-.04,0-.09.03-.13.06l-.16.12c-.15.11-.18.32-.07.48l5.5,7.34c.11.15.32.18.48.07l.16-.12c.15-.11.18-.32.07-.48l-5.28-7.05c3.98-2.62,9.3-1.71,12.17,2.12.11.15.32.18.48.07s.18-.32.07-.48c-2.81-3.75-2.26-8.96,1.17-12.07l5.27,7.04c.11.15.32.18.48.07l.16-.12c.15-.11.18-.32.07-.48l-5.5-7.34c-.11-.15-.32-.18-.48-.07l.02-.02Z"/>
      </g>
      <g id="STAIRS">
        <g>
          <g>
      ...
      <g id="SolidWall">
        ...
        <polygon className={styles.cls13} points="767.91 38.75 767.91 41.23 813.17 41.23 813.17 46.75 814.66 46.75 814.66 76.37 767.91 76.37 767.91 78.79 814.66 78.79 814.66 101.54 810.8 101.54 810.8 103.89 816.75 103.89 816.75 46.75 818.24 46.75 818.24 38.75 767.91 38.75"/>
        ...
        <polygon className={styles.cls13} points="430.66 258.42 425.91 258.42 425.91 266.66 283.73 266.66 283.73 269.22 430.66 269.22 430.66 258.42"/>
        <rect className={styles.cls13} x="416.52" y="270.19" width="2.74" height="94.42"/>
        <path className={styles.cls13} d="m429.59,132.89h0v-2.56h-133.54c-15.57-33.7-43.35-60.64-77.63-75.13l7.39-16.6h48.11v19.9h2v-19.9h19.02v19.9h2v-19.9h128.81v7.76h4.67v-7.76h52.59v7.82h4.57v-19.22h-2.28v8.49H223.91s-8.19,18.4-8.19,18.4c0,0,0,0,0,0l-1.22,2.74c35.3,14.07,63.87,41.52,79.42,76.05h135.67Z"/>
      ...
      <path id="Floor-2" data-name="Floor" className={styles.cls11} d="m810.24,32.98h-40.56v7.44h-1.63v-1.07s-280.88-.28-280.88-.28l-.19-2.09H225.22l-8,18.05c57.12,24.56,78.33,76.28,78.33,76.28h132.69v-16.19h93.82v-55.4h220.33v58.88l24.6-.14v-3.81h1.4v2.23h70.6V47.49l-28.74-14.51Z"/>
    </g>
    <g id="text">
      <g id="t1">
        <g className={styles.cls40}>
          <text className={styles.cls17} transform="translate(330.36 92.23)"><tspan className={styles.cls32} x="0" y="0">C</tspan><tspan x="4.27" y="0">a</tspan><tspan className={styles.cls29} x="7.81" y="0">m</tspan><tspan className={styles.cls28} x="14.18" y="0">e</tspan><tspan className={styles.cls20} x="17.81" y="0">r</tspan><tspan x="20.16" y="0">a Main</tspan><tspan className={styles.cls41} x="40.22" y="0">t</tspan><tspan x="42.54" y="0">ena</tspan><tspan className={styles.cls29} x="53.77" y="0">n</tspan><tspan className={styles.cls24} x="57.84" y="0">c</tspan><tspan x="61.16" y="0">e</tspan><tspan className={styles.cls32} x="23.71" y="7.2">H</tspan><tspan className={styles.cls26} x="28.54" y="7.2">V</tspan><tspan className={styles.cls42} x="32.52" y="7.2">A</tspan><tspan x="36.76" y="7.2">C</tspan><tspan x="23.28" y="14.4">Room</tspan></text>
          <text className={styles.cls17} transform="translate(330.36 92.23)"><tspan className={styles.cls32} x="0" y="0">C</tspan><tspan x="4.27" y="0">a</tspan><tspan className={styles.cls29} x="7.81" y="0">m</tspan><tspan className={styles.cls28} x="14.18" y="0">e</tspan><tspan className={styles.cls20} x="17.81" y="0">r</tspan><tspan x="20.16" y="0">a Main</tspan><tspan className={styles.cls41} x="40.22" y="0">t</tspan><tspan x="42.54" y="0">ena</tspan><tspan className={styles.cls29} x="53.77" y="0">n</tspan><tspan className={styles.cls24} x="57.84" y="0">c</tspan><tspan x="61.16" y="0">e</tspan><tspan className={styles.cls32} x="23.71" y="7.2">H</tspan><tspan className={styles.cls26} x="28.54" y="7.2">V</tspan><tspan className={styles.cls42} x="32.52" y="7.2">A</tspan><tspan x="36.76" y="7.2">C</tspan><tspan x="23.28" y="14.4">Room</tspan></text>
        </g>
        <g className={styles.cls40}>
          <text className={styles.cls17} transform="translate(636.81 167.58)"><tspan x="0" y="0">Open </tspan><tspan className={styles.cls41} x="18.36" y="0">t</tspan><tspan x="20.68" y="0">o</tspan><tspan x="-15.99" y="7.2">Main</tspan><tspan className={styles.cls41} x="-1.05" y="7.2">t</tspan><tspan x="1.27" y="7.2">ena</tspan><tspan className={styles.cls43} x="12.5" y="7.2">n</tspan><tspan className={styles.cls20} x="16.57" y="7.2">c</tspan><tspan x="19.9" y="7.2">e Floor</tspan><tspan x="3.1" y="14.4">bel</tspan><tspan className={styles.cls22} x="12.4" y="14.4">o</tspan><tspan x="16.07" y="14.4">w</tspan></text>
          <text className={styles.cls17} transform="translate(636.81 167.58)"><tspan x="0" y="0">Open </tspan><tspan className={styles.cls41} x="18.36" y="0">t</tspan><tspan x="20.68" y="0">o</tspan><tspan x="-15.99" y="7.2">Main</tspan><tspan className={styles.cls41} x="-1.05" y="7.2">t</tspan><tspan x="1.27" y="7.2">ena</tspan><tspan className={styles.cls43} x="12.5" y="7.2">n</tspan><tspan className={styles.cls20} x="16.57" y="7.2">c</tspan><tspan x="19.9" y="7.2">e Floor</tspan><tspan x="3.1" y="14.4">bel</tspan><tspan className={styles.cls22} x="12.4" y="14.4">o</tspan><tspan x="16.07" y="14.4">w</tspan></text>
        </g>
        <g className={styles.cls40}>
          <text className={styles.cls17} transform="translate(461.56 98.46)"><tspan x="0" y="0">No</tspan><tspan className={styles.cls35} x="8.64" y="0">r</tspan><tspan x="11.14" y="0">th</tspan><tspan x="-8.52" y="7.2">M</tspan><tspan className={styles.cls15} x="-2.79" y="7.2">e</tspan><tspan x=".8" y="7.2">zzanin</tspan><tspan className={styles.cls2} x="20.21" y="7.2">t</tspan><tspan x="22.53" y="7.2">e</tspan></text>
          <text className={styles.cls17} transform="translate(461.56 98.46)"><tspan x="0" y="0">No</tspan><tspan className={styles.cls35} x="8.64" y="0">r</tspan><tspan x="11.14" y="0">th</tspan><tspan x="-8.52" y="7.2">M</tspan><tspan className={styles.cls15} x="-2.79" y="7.2">e</tspan><tspan x=".8" y="7.2">zzanin</tspan><tspan className={styles.cls2} x="20.21" y="7.2">t</tspan><tspan x="22.53" y="7.2">e</tspan></text>
        </g>
        <g className={styles.cls40}>
          <text className={styles.cls17} transform="translate(756.12 128.11)"><tspan x="0" y="0">South M</tspan><tspan className={styles.cls45} x="25.29" y="0">e</tspan><tspan x="28.88" y="0">zanni</tspan><tspan className={styles.cls43} x="45.23" y="0">n</tspan><tspan x="49.3" y="0">e</tspan></text>
          <text className={styles.cls17} transform="translate(756.12 128.11)"><tspan x="0" y="0">South M</tspan><tspan className={styles.cls45} x="25.29" y="0">e</tspan><tspan x="28.88" y="0">zanni</tspan><tspan className={styles.cls43} x="45.23" y="0">n</tspan><tspan x="49.3" y="0">e</tspan></text>
        </g>
        <g className={styles.cls40}>
          <text className={styles.cls17} transform="translate(366.07 197.01)"><tspan x="0" y="0">8</tspan><tspan className={styles.cls39} x="3.83" y="0">0</tspan><tspan className={styles.cls44} x="7.85" y="0">-</tspan><tspan className={styles.cls27} x="9.95" y="0">T</tspan><tspan x="13.06" y="0">on</tspan><tspan x="-8.33" y="7.2">Plat</tspan><tspan className={styles.cls24} x="3.56" y="7.2">f</tspan><tspan className={styles.cls28} x="5.54" y="7.2">o</tspan><tspan className={styles.cls32} x="9.31" y="7.2">r</tspan><tspan className={styles.cls25} x="11.66" y="7.2">m Lift</tspan></text>
          <text className={styles.cls17} transform="translate(366.07 197.01)"><tspan x="0" y="0">8</tspan><tspan className={styles.cls39} x="3.83" y="0">0</tspan><tspan className={styles.cls44} x="7.85" y="0">-</tspan><tspan className={styles.cls27} x="9.95" y="0">T</tspan><tspan x="13.06" y="0">on</tspan><tspan x="-8.33" y="7.2">Plat</tspan><tspan className={styles.cls24} x="3.56" y="7.2">f</tspan><tspan className={styles.cls28} x="5.54" y="7.2">o</tspan><tspan className={styles.cls32} x="9.31" y="7.2">r</tspan><tspan className={styles.cls25} x="11.66" y="7.2">m Lift</tspan></text>
        </g>
        <g className={styles.cls40}>
          <text className={styles.cls17} transform="translate(657.85 296.73)"><tspan x="0" y="0">De</tspan><tspan className={styles.cls38} x="8.58" y="0">c</tspan><tspan x="11.91" y="0">k</tspan></text>
          <text className={styles.cls17} transform="translate(657.85 296.73)"><tspan x="0" y="0">De</tspan><tspan className={styles.cls38} x="8.58" y="0">c</tspan><tspan x="11.91" y="0">k</tspan></text>
        </g>
      </g>
      <g id="t2" className={styles.cls36}>
        <g className={styles.cls40}>
          <text className={styles.cls19} transform="translate(774.92 59.94)"><tspan className={styles.cls23} x="0" y="0">W</tspan><tspan x="4.22" y="0">et Shaft</tspan></text>
          <text className={styles.cls19} transform="translate(774.92 59.94)"><tspan className={styles.cls23} x="0" y="0">W</tspan><tspan x="4.22" y="0">et Shaft</tspan></text>
        </g>
        <g className={styles.cls40}>
          <text className={styles.cls19} transform="translate(802.06 92.28)"><tspan x="0" y="0">D</tspan><tspan className={styles.cls31} x="3.3" y="0">r</tspan><tspan x="4.97" y="0">y</tspan><tspan x="-1.69" y="4.8">Shaft</tspan></text>
          <text className={styles.cls19} transform="translate(802.06 92.28)"><tspan x="0" y="0">D</tspan><tspan className={styles.cls31} x="3.3" y="0">r</tspan><tspan x="4.97" y="0">y</tspan><tspan x="-1.69" y="4.8">Shaft</tspan></text>
        </g>
        <g className={styles.cls40}>
          <text className={styles.cls19} transform="translate(774.48 87.54)"><tspan x="0" y="0">El</tspan><tspan className={styles.cls1} x="3.75" y="0">e</tspan><tspan className={styles.cls21} x="6.13" y="0">v</tspan><tspan className={styles.cls33} x="8.16" y="0">. 1</tspan></text>
          <text className={styles.cls19} transform="translate(774.48 87.54)"><tspan x="0" y="0">El</tspan><tspan className={styles.cls1} x="3.75" y="0">e</tspan><tspan className={styles.cls21} x="6.13" y="0">v</tspan><tspan className={styles.cls33} x="8.16" y="0">. 1</tspan></text>
        </g>
        <g className={styles.cls40}>
          <text className={styles.cls19} transform="translate(614.37 53.07)"><tspan className={styles.cls38} x="0" y="0">C</tspan><tspan className={styles.cls37} x="2.84" y="0">a</tspan><tspan className={styles.cls1} x="5.2" y="0">t</tspan><tspan className={styles.cls30} x="6.79" y="0">w</tspan><tspan x="10.24" y="0">alk</tspan></text>
          <text className={styles.cls19} transform="translate(614.37 53.07)"><tspan className={styles.cls38} x="0" y="0">C</tspan><tspan className={styles.cls37} x="2.84" y="0">a</tspan><tspan className={styles.cls1} x="5.2" y="0">t</tspan><tspan className={styles.cls30} x="6.79" y="0">w</tspan><tspan x="10.24" y="0">alk</tspan></text>
        </g>
        <g className={styles.cls40}>
          <text className={styles.cls19} transform="translate(279.43 50.65)"><tspan x="0" y="0">El</tspan><tspan className={styles.cls1} x="3.75" y="0">e</tspan><tspan className={styles.cls21} x="6.13" y="0">v</tspan><tspan className={styles.cls33} x="8.16" y="0">. 2</tspan></text>
          <text className={styles.cls19} transform="translate(279.43 50.65)"><tspan x="0" y="0">El</tspan><tspan className={styles.cls1} x="3.75" y="0">e</tspan><tspan className={styles.cls21} x="6.13" y="0">v</tspan><tspan className={styles.cls33} x="8.16" y="0">. 2</tspan></text>
        </g>
      </g>
    </g>
    ...
    <g id="Outside">
      <polyline className={styles.cls7} points="422.01 19.12 526.01 19.12 526.01 12.42 755.49 12.42 856.47 19.26 882.79 35.22 882.79 270.01 856.47 285.97 832.8 285.97"/>
      <polyline className={styles.cls7} points="526.01 19.12 832.8 19.12 876.61 44.09 876.61 261.07 832.8 286.19 419.36 286.19"/>
      <polyline className={styles.cls7} points="426.05 27.21 811.17 27.21 844.52 43.96 844.52 261.49 812.7 278.09 418.8 278.09 418.8 273.91 811.59 273.91 841.03 259.12 841.03 46.19 810.05 30.84 487.45 30.84 487.45 32.65 810.47 32.65 838.94 47.44 838.94 258.14 811.59 272.65 418.8 272.65"/>
      <g>
