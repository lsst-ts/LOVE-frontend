...
export default class Level7 extends Component {
  ...
  <g id="Level7">
    ...
    <g>
      ...
      <polyline className={styles.cls7} points="206.57 37.89 780.82 37.89 696.68 152.3 780.82 268.12 286.23 268.12"/>
    ...
    <g id="text">
      <g id="t1">
        <g className={styles.cls26}>
          <text className={styles.cls18} transform="translate(155.37 149.4)"><tspan className={styles.cls13} x="0" y="0">P</tspan><tspan x="4.17" y="0">ier</tspan><tspan x="-22.22" y="7.2">In</tspan><tspan className={styles.cls27} x="-16.35" y="7.2">t</tspan><tspan x="-14.03" y="7.2">e</tspan><tspan className={styles.cls23} x="-10.4" y="7.2">r</tspan><tspan className={styles.cls22} x="-8.05" y="7.2">m</tspan><tspan x="-1.67" y="7.2">edia</tspan><tspan className={styles.cls3} x="11.18" y="7.2">t</tspan><tspan className={styles.cls21} x="13.5" y="7.2">e Floor</tspan></text>
          <text className={styles.cls18} transform="translate(155.37 149.4)"><tspan className={styles.cls13} x="0" y="0">P</tspan><tspan x="4.17" y="0">ier</tspan><tspan x="-22.22" y="7.2">In</tspan><tspan className={styles.cls27} x="-16.35" y="7.2">t</tspan><tspan x="-14.03" y="7.2">e</tspan><tspan className={styles.cls23} x="-10.4" y="7.2">r</tspan><tspan className={styles.cls22} x="-8.05" y="7.2">m</tspan><tspan x="-1.67" y="7.2">edia</tspan><tspan className={styles.cls3} x="11.18" y="7.2">t</tspan><tspan className={styles.cls21} x="13.5" y="7.2">e Floor</tspan></text>
        </g>
      </g>
      <g id="t2" className={styles.cls24}>
        <g className={styles.cls26}>
          <text className={styles.cls19} transform="translate(212.71 193.75)"><tspan x="0" y="0">Ha</tspan><tspan className={styles.cls2} x="5.61" y="0">t</tspan><tspan className={styles.cls25} x="7.16" y="0">c</tspan><tspan x="9.38" y="0">h</tspan></text>
          <text className={styles.cls19} transform="translate(212.71 193.75)"><tspan x="0" y="0">Ha</tspan><tspan className={styles.cls2} x="5.61" y="0">t</tspan><tspan className={styles.cls25} x="7.16" y="0">c</tspan><tspan x="9.38" y="0">h</tspan></text>
        </g>
      </g>
    </g>
    <rect className={styles.cls8} x="201.64" y="74.42" width="21.05" height="19.23" transform="translate(371.8 247.09) rotate(-156)"/>
    <g id="t2-2" data-name="t2" className={styles.cls24}>
      <g className={styles.cls26}>
        <text className={styles.cls19} transform="translate(206.67 84.73)"><tspan x="0" y="0">El</tspan><tspan className={styles.cls1} x="3.75" y="0">e</tspan><tspan className={styles.cls14} x="6.13" y="0">v</tspan><tspan x="8.16" y="0">. 3</tspan></text>
        <text className={styles.cls19} transform="translate(206.67 84.73)"><tspan x="0" y="0">El</tspan><tspan className={styles.cls1} x="3.75" y="0">e</tspan><tspan className={styles.cls14} x="6.13" y="0">v</tspan><tspan x="8.16" y="0">. 3</tspan></text>
      </g>
    </g>
    <path className={styles.cls17} d="m194.46,83.28c.18.08.25.29.17.47l-4.07,8.73c-.08.18-.29.25-.47.17l-.09-.04c-.18-.08-.25-.29-.17-.47l3.91-8.39c-4.57-1.8-9.73.24-11.82,4.71-.08.18-.29.25-.47.17s-.25-.29-.17-.47c2.27-4.87,7.94-7.07,12.9-5.01.04.02.07.03.1.07.03.01.06,0,.09.02l.09.04h-.01Z"/>
    <polygon className={styles.cls7} points="178.48 86.69 178.48 73.04 145.76 73.36 145.76 75.42 177.06 75.42 177.06 86.69 135.08 86.51 135.08 62.37 190.24 62.37 205.17 69.09 203.03 73.9 204.22 74.43 206.35 69.62 232.97 81.6 222.08 106.22 195.36 94.31 199.76 84.43 198.57 83.9 194.17 93.78 190.88 92.32 190.14 93.77 222.61 108.23 234.69 80.94 190.52 61.07 133.77 61.07 133.77 88.14 177.99 88.14 180.58 89.44 181.24 88.02 178.48 86.69"/>
    <g id="Stairs">
      <polygon className={styles.cls11} points="144.96 76.14 144.96 72.81 175.57 72.81 175.57 63.13 135.84 63.13 135.84 68.47 135.84 72.81 135.84 76.14 135.84 85.83 144.96 85.83 175.57 85.83 175.57 76.14 144.96 76.14"/>
    ...
    <g id="Stairs-2" data-name="Stairs">
      <polyline className={styles.cls11} points="74.88 276.28 58.17 252.02 40.27 264.49 57.26 289.16 65.81 283.19 54.67 266.94 55.33 266.44 66.19 282.28"/>
