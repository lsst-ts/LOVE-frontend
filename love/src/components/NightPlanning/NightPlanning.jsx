...
function NightPlanning({
  ...
  useEffect(() => {
    ...
    // Query night plans
    ManagerInterface.getNightPlanTestCycles().then((data) => {
      if (data) {
        setTestCyclesData(data);
      }
    });
  ...
  useEffect(() => {
    ...
    ManagerInterface.getNightPlanTestCycle(selectedTestCycle).then((data) => {
      if (data) {
        setTestCycleData(data);
      }
    });
    ManagerInterface.getNightPlanTestCases(selectedTestCycle).then((data) => {
      if (data) {
  ...
  useEffect(() => {
    ...
    ManagerInterface.getNightPlanTestCaseExecution(selectedTestCase).then((data) => {
      if (data) {
