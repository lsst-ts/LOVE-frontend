...
export default class SimonyiTelescope extends Component {
  render() {
    return (
      <svg viewBox="0 0 726.72 436.7" /**width={720} height={750}*/>
        <g id="Simonyi">
          <g id="TMA">
            <g>
              <g>
                <rect className={styles.cls - 4} x="153.4" y="44.72" width="16.11" height="54.37" />
                <polygon
                  className={styles.cls - 4}
                  points="169.19 103.97 153.73 103.97 153.4 99.09 169.51 99.09 169.19 103.97"
                />
                <rect className={styles.cls - 8} x="143.43" y="52.29" width="36.05" height="28.63" />
              </g>
              <rect
                className={styles.cls - 4}
                x="115.25"
              ...
              />
              <rect className={styles.cls - 3} x="129.35" y="136.68" width="64.39" height="19.13" />
              <path
                className={styles.cls - 3}
              ...
              />
              <path className={styles.cls - 3} d="m210.24,58.31h-97.56l-1.3,7.8h100.16l-1.3-7.8Z" />
            </g>
            <g>
              <g>
                <path
              ...
              <rect className={styles.cls - 2} x="80.93" y="169.76" width="161.29" height="5.28" />
            </g>
          </g>
          <polygon
            id="Facility"
        ...
        <g id="LiftSchute">
          <rect className={styles.cls - 1} x="286.38" y="175.7" width="98.48" height="200" />
          <line className={styles.cls - 7} x1="287.38" y1="335.7" x2="383.85" y2="335.7" />
          <line className={styles.cls - 7} x1="287.38" y1="295.7" x2="383.85" y2="295.7" />
          <line className={styles.cls - 7} x1="287.38" y1="255.7" x2="383.85" y2="255.7" />
          <polyline className={styles.cls - 7} points="286.38 174.7 286.38 135.7 384.85 135.7 384.85 174.7" />
          <line className={styles.cls - 7} x1="287.38" y1="215.7" x2="383.85" y2="215.7" />
        </g>
        <g id="Floors" className={styles.cls - 10}>
          <text className={styles.cls - 9} transform="translate(326.84 362.67)">
            <tspan x="0" y="0">
              3
            </tspan>
          </text>
          <text className={styles.cls - 9} transform="translate(325.87 322.44)">
            <tspan x="0" y="0">
              4
            </tspan>
          </text>
          <text className={styles.cls - 9} transform="translate(326.81 282.21)">
            <tspan x="0" y="0">
              5
            </tspan>
          </text>
          <text className={styles.cls - 9} transform="translate(326.39 241.97)">
            <tspan x="0" y="0">
              6
            </tspan>
          </text>
          <text className={styles.cls - 9} transform="translate(326.56 201.74)">
            <tspan x="0" y="0">
              7
            </tspan>
          </text>
          <text className={styles.cls - 9} transform="translate(326.16 161.51)">
            <tspan x="0" y="0">
              8
            </tspan>
          </text>
        ...
        <g id="Platform">
          ...
          />
          <rect className={styles.cls - 3} x="300.62" y="260.98" width="70" height="10" />
          <path className={styles.cls - 5} d="m358.12,260.98c0,3.31-10.07,6-22.5,6s-22.5-2.69-22.5-6" />
        </g>
      </svg>
    );
  }
