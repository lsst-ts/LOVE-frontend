...
export default class AuxTelescope extends Component {
  render() {
    return (
      <svg viewBox="0 0 444.43 436.59" /**width={500} height={500}*/>
        <g id="AuxTel">
          <g id="ATMount">
            <rect className={styles.cls - 1} x="242.87" y="117.66" width="30" height="8" />
            <g>
              <rect className={styles.cls - 1} x="237.08" y="124.52" width="41.58" height="6.14" />
              <polygon
              ...
              />
              <rect className={styles.cls - 3} x="251.32" y="62.84" width="13.12" height="37.12" />
              <rect className={styles.cls - 4} x="242.87" y="29.66" width="30" height="50" />
              <rect className={styles.cls - 3} x="253.87" y="23.96" width="8" height="10" />
              <polygon
                className={styles.cls - 4}
                points="272.87 29.66 242.87 29.66 256.87 79.66 258.87 79.66 272.87 29.66"
              />
              <rect className={styles.cls - 2} x="238.78" y="81.66" width="38.18" height="8" />
            </g>
          </g>
          ...
          <g id="ATDome">
            <rect className={styles.cls - 2} x="169.41" y="132.63" width="176.93" height="45" />
            <path
