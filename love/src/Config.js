...
export const M1M3ActuatorForces = {
  ...
  faMeasuredForces: ['xForces', 'yForces', 'zForces', 'primaryCylinderForces', 'secondaryCylinderForces'],
...
export const M1M3ActuatorForcesTopics = {
  ...
  appliedActiveOpticForces: 'appliedOpticForces',
  ...
  faForceWarning: 'forceActuatorWarning',
