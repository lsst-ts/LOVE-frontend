...
export const getGlycolSystemData = (state) => {
  ...
  return {
    ...
    glycoL2CRACStemperatureOut: data['telemetry-HVAC-0-glycolSensor']?.retTempFloor2?.value ?? undefined,
    glycoL2CRACSpressureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyPressFloor2?.value ?? undefined,
    glycoL2CRACSpressureOut: data['telemetry-HVAC-0-glycolSensor']?.retPressFloor2?.value ?? undefined,
