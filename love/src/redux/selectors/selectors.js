...
export const getObservatoryStatuses = (state, salindex) => {
  const subscriptions = [`event-Scheduler-${salindex}-observatoryStatus`];
  const data = getStreamsData(state, subscriptions);
  return data[`event-Scheduler-${salindex}-observatoryStatus`]?.[0];
};
...
export const getDynaleneData = (state) => {
  const subscriptions = ['telemetry-HVAC-0-dynalene'];
  const dynaleneData = getStreamsData(state, subscriptions);
  return {
    dynCH01LS01: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH01LS01?.value ?? undefined,
    dynCH01supFS01: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH01supFS01?.value ?? undefined,
    dynCH01supPS11: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH01supPS11?.value ?? undefined,
    dynCH01supTS05: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH01supTS05?.value ?? undefined,
    dynCH02LS02: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH02LS02?.value ?? undefined,
    dynCH02supFS02: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH02supFS02?.value ?? undefined,
    dynCH02supPS13: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH02supPS13?.value ?? undefined,
    dynCH02supTS07: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH02supTS07?.value ?? undefined,
    dynCH01retCGLYpres: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH01retCGLYpres?.value ?? undefined,
    dynCH01retCGLYtemp: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH01retCGLYtemp?.value ?? undefined,
    dynCH01supCGLYpres: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH01supCGLYpres?.value ?? undefined,
    dynCH01supCGLYtemp: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH01supCGLYtemp?.value ?? undefined,
    dynCH02retGPGLYpres: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH02retGPGLYpres?.value ?? undefined,
    dynCH02retGPGLYtemp: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH02retGPGLYtemp?.value ?? undefined,
    dynCH02supGPGLYpres: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH02supGPGLYpres?.value ?? undefined,
    dynCH02supGPGLYtemp: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH02supGPGLYtemp?.value ?? undefined,
    dynCH1CGLYtpd: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH1CGLYtpd?.value ?? undefined,
    dynCH1supCGLYflow: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH1supCGLYflow?.value ?? undefined,
    dynCH2GPGLYtpd: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH2GPGLYtpd?.value ?? undefined,
    dynCH2supGPGLYflow: dynaleneData['telemetry-HVAC-0-dynalene']?.dynCH2supGPGLYflow?.value ?? undefined,
    dynTAretPS04: dynaleneData['telemetry-HVAC-0-dynalene']?.dynTAretPS04?.value ?? undefined,
    dynTAretTS04: dynaleneData['telemetry-HVAC-0-dynalene']?.dynTAretTS04?.value ?? undefined,
    dynTAsupFS04: dynaleneData['telemetry-HVAC-0-dynalene']?.dynTAsupFS04?.value ?? undefined,
    dynTAsupPS03: dynaleneData['telemetry-HVAC-0-dynalene']?.dynTAsupPS03?.value ?? undefined,
    dynTAsupTS03: dynaleneData['telemetry-HVAC-0-dynalene']?.dynTAsupTS03?.value ?? undefined,
    dynTAtpd: dynaleneData['telemetry-HVAC-0-dynalene']?.dynTAtpd?.value ?? undefined,
    dynTMAcmv01pos: dynaleneData['telemetry-HVAC-0-dynalene']?.dynTMAcmv01pos?.value ?? undefined,
    dynTMAcmv02pos: dynaleneData['telemetry-HVAC-0-dynalene']?.dynTMAcmv02pos?.value ?? undefined,
    dynTMAretPS02: dynaleneData['telemetry-HVAC-0-dynalene']?.dynTMAretPS02?.value ?? undefined,
    dynTMAretTS02: dynaleneData['telemetry-HVAC-0-dynalene']?.dynTMAretTS02?.value ?? undefined,
    dynTMAsupFS03: dynaleneData['telemetry-HVAC-0-dynalene']?.dynTMAsupFS03?.value ?? undefined,
    dynTMAsupPS01: dynaleneData['telemetry-HVAC-0-dynalene']?.dynTMAsupPS01?.value ?? undefined,
    dynTMAsupTS01: dynaleneData['telemetry-HVAC-0-dynalene']?.dynTMAsupTS01?.value ?? undefined,
    dynTMAtpd: dynaleneData['telemetry-HVAC-0-dynalene']?.dynTMAtpd?.value ?? undefined,
    exhAirAvrgTemp: dynaleneData['telemetry-HVAC-0-dynalene']?.exhAirAvrgTemp?.value ?? undefined,
  };
};

export const getGlycolSystemData = (state) => {
  const subscriptions = ['telemetry-HVAC-0-glycolLineSensors', 'telemetry-HVAC-0-dynalene'];

  const data = getStreamsData(state, subscriptions);
  return {
    glycolCH01flow: data['telemetry-HVAC-0-glycolLineSensors']?.supplyFlowChiller01?.value ?? undefined,
    glycolCH01temperatureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyTempChiller01?.value ?? undefined,
    glycolCH01temperatureOut: data['telemetry-HVAC-0-glycolLineSensors']?.retTempChiller01?.value ?? undefined,
    glycolCH01pressureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyPressChiller01?.value ?? undefined,
    glycolCH01pressureOut: data['telemetry-HVAC-0-glycolLineSensors']?.retPressChiller01?.value ?? undefined,
    glycolCH02flow: data['telemetry-HVAC-0-glycolLineSensors']?.supplyFlowChiller02?.value ?? undefined,
    glycolCH02temperatureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyTempChiller02?.value ?? undefined,
    glycolCH02temperatureOut: data['telemetry-HVAC-0-glycolLineSensors']?.retTempChiller02?.value ?? undefined,
    glycolCH02pressureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyPressChiller02?.value ?? undefined,
    glycolCH02pressureOut: data['telemetry-HVAC-0-glycolLineSensors']?.retPressChiller02?.value ?? undefined,
    glycolCH03flow: data['telemetry-HVAC-0-glycolLineSensors']?.supplyFlowChiller03?.value ?? undefined,
    glycolCH03temperatureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyTempChiller03?.value ?? undefined,
    glycolCH03temperatureOut: data['telemetry-HVAC-0-glycolLineSensors']?.retTempChiller03?.value ?? undefined,
    glycolCH03pressureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyPressChiller03?.value ?? undefined,
    glycolCH03pressureOut: data['telemetry-HVAC-0-glycolLineSensors']?.retPressChiller03?.value ?? undefined,
    glycolOSSflow: data['telemetry-HVAC-0-glycolLineSensors']?.supplyFlowOss?.value ?? undefined,
    glycolOSStemperatureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyTempOss?.value ?? undefined,
    glycolOSStemperatureOut: data['telemetry-HVAC-0-glycolLineSensors']?.retTempOss?.value ?? undefined,
    glycolOSSpressureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyPressOss?.value ?? undefined,
    glycolOSSpressureOut: data['telemetry-HVAC-0-glycolLineSensors']?.retPressOss?.value ?? undefined,
    glycolSLACflow: data['telemetry-HVAC-0-glycolLineSensors']?.supplyFlowSlac?.value ?? undefined,
    glycolSLACtemperatureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyTempSlac?.value ?? undefined,
    glycolSLACtemperatureOut: data['telemetry-HVAC-0-glycolLineSensors']?.retTempSlac?.value ?? undefined,
    glycolSLACpressureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyPressSlac?.value ?? undefined,
    glycolSLACpressureOut: data['telemetry-HVAC-0-glycolLineSensors']?.retPressSlac?.value ?? undefined,
    glycoL2CRACSflow: data['telemetry-HVAC-0-glycolLineSensors']?.supplyFlowFloor2?.value ?? undefined,
    glycoL2CRACStemperatureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyTempFloor2?.value ?? undefined,
    glycoL2CRACStemperatureOut: data['telemetry-HVAC-0-glycolLineSensors']?.returnTempFloor2?.value ?? undefined,
    glycoL2CRACSpressureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyPressFloor2?.value ?? undefined,
    glycoL2CRACSpressureOut: data['telemetry-HVAC-0-glycolLineSensors']?.returnPressFloor2?.value ?? undefined,

    glycoL2FCflow: data['telemetry-HVAC-0-glycolLineSensors']?.comfortSupplyFlowFloor02?.value ?? undefined,
    glycoL2FCtemperatureIn: data['telemetry-HVAC-0-glycolLineSensors']?.comfortSupplyTempFloor02?.value ?? undefined,
    glycoL2FCtemperatureOut: data['telemetry-HVAC-0-glycolLineSensors']?.comfortRetTempFloor02?.value ?? undefined,
    glycoL2FCpressureIn: data['telemetry-HVAC-0-glycolLineSensors']?.comfortSupplyPressFloor02?.value ?? undefined,
    glycoL2FCpressureOut: data['telemetry-HVAC-0-glycolLineSensors']?.comfortRetPressFloor02?.value ?? undefined,

    glycolAHUCRflow: data['telemetry-HVAC-0-glycolLineSensors']?.supplyFlowCleanRoom?.value ?? undefined,
    glycolAHUCRtemperatureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyTempCleanRoom?.value ?? undefined,
    glycolAHUCRtemperatureOut: data['telemetry-HVAC-0-glycolLineSensors']?.returnTempCleanRoom?.value ?? undefined,
    glycolAHUCRpressureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyPressCleanRoom?.value ?? undefined,
    glycolAHUCRpressureOut: data['telemetry-HVAC-0-glycolLineSensors']?.returnPressCleanRoom?.value ?? undefined,
    glycolAHUWRflow: data['telemetry-HVAC-0-glycolLineSensors']?.supplyFlowWhiteRoom?.value ?? undefined,
    glycolAHUWRtemperatureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyTempWhiteRoom?.value ?? undefined,
    glycolAHUWRtemperatureOut: data['telemetry-HVAC-0-glycolLineSensors']?.returnTempWhiteRoom?.value ?? undefined,
    glycolAHUWRpressureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyPressWhiteRoom?.value ?? undefined,
    glycolAHUWRpressureOut: data['telemetry-HVAC-0-glycolLineSensors']?.returnPressWhiteRoom?.value ?? undefined,
    glycolDOMEAHU01flow: data['telemetry-HVAC-0-glycolLineSensors']?.supplyFlowAhuLower1?.value ?? undefined,
    glycolDOMEAHU01temperatureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyTempAhuLower1?.value ?? undefined,
    glycolDOMEAHU01temperatureOut: data['telemetry-HVAC-0-glycolLineSensors']?.returnTempAhuLower1?.value ?? undefined,
    glycolDOMEAHU01pressureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyPressAhuLower1?.value ?? undefined,
    glycolDOMEAHU01pressureOut: data['telemetry-HVAC-0-glycolLineSensors']?.returnPressAhuLower1?.value ?? undefined,
    glycolDOMEAHU02flow: data['telemetry-HVAC-0-glycolLineSensors']?.supplyFlowAhuLower2?.value ?? undefined,
    glycolDOMEAHU02temperatureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyTempAhuLower2?.value ?? undefined,
    glycolDOMEAHU02temperatureOut: data['telemetry-HVAC-0-glycolLineSensors']?.returnTempAhuLower2?.value ?? undefined,
    glycolDOMEAHU02pressureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyPressAhuLower2?.value ?? undefined,
    glycolDOMEAHU02pressureOut: data['telemetry-HVAC-0-glycolLineSensors']?.returnPressAhuLower2?.value ?? undefined,
    glycolDOMEAHU03flow: data['telemetry-HVAC-0-glycolLineSensors']?.supplyFlowAhuLower3?.value ?? undefined,
    glycolDOMEAHU03temperatureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyTempAhuLower3?.value ?? undefined,
    glycolDOMEAHU03temperatureOut: data['telemetry-HVAC-0-glycolLineSensors']?.returnTempAhuLower3?.value ?? undefined,
    glycolDOMEAHU03pressureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyPressAhuLower3?.value ?? undefined,
    glycolDOMEAHU03pressureOut: data['telemetry-HVAC-0-glycolLineSensors']?.returnPressAhuLower3?.value ?? undefined,
    glycolDOMEAHU04flow: data['telemetry-HVAC-0-glycolLineSensors']?.supplyFlowAhuLower4?.value ?? undefined,
    glycolDOMEAHU04temperatureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyTempAhuLower4?.value ?? undefined,
    glycolDOMEAHU04temperatureOut: data['telemetry-HVAC-0-glycolLineSensors']?.returnTempAhuLower4?.value ?? undefined,
    glycolDOMEAHU04pressureIn: data['telemetry-HVAC-0-glycolLineSensors']?.supplyPressAhuLower4?.value ?? undefined,
    glycolDOMEAHU04pressureOut: data['telemetry-HVAC-0-glycolLineSensors']?.returnPressAhuLower4?.value ?? undefined,
    // glycolDynalene01flow: data['telemetry-HVAC-0-dynalene']?.dynCH1supCGLYflow?.value ?? undefined, // dynCH01supFS01?
    // glycolDynalene01temperatureIn: data['telemetry-HVAC-0-dynalene']?.dynCH01supCGLYtemp?.value ?? undefined, // dynCH01supTS05
    // glycolDynalene01temperatureOut: data['telemetry-HVAC-0-dynalene']?.dynCH01retCGLYtemp?.value ?? undefined,
    // glycolDynalene01pressureIn: data['telemetry-HVAC-0-dynalene']?.dynCH01supCGLYpres?.value ?? undefined, // dynCH01supPS11
    // glycolDynalene01pressureOut: data['telemetry-HVAC-0-dynalene']?.dynCH01retCGLYpres?.value ?? undefined,
    // glycolDynalene02flow: data['telemetry-HVAC-0-dynalene']?.dynCH2supGPGLYflow?.value ?? undefined, // dynCH02supFS02
    // glycolDynalene02temperatureIn: data['telemetry-HVAC-0-dynalene']?.dynCH02supGPGLYtemp?.value ?? undefined, // dynCH02supTS07
    // glycolDynalene02temperatureOut: data['telemetry-HVAC-0-dynalene']?.dynCH02retGPGLYtemp?.value ?? undefined,
    // glycolDynalene02pressureIn: data['telemetry-HVAC-0-dynalene']?.dynCH02supGPGLYpres?.value ?? undefined, // dynCH02supPS13
    // glycolDynalene02pressureOut: data['telemetry-HVAC-0-dynalene']?.dynCH02retGPGLYpres?.value ?? undefined,
    // glycolTMAflow: data['telemetry-HVAC-0-dynalene']?.dynTMAsupFS03?.value ?? undefined,
    // glycolTMAtemperatureIn: data['telemetry-HVAC-0-dynalene']?.dynTMAsupTS01?.value ?? undefined,
    // glycolTMAtemperatureOut: data['telemetry-HVAC-0-dynalene']?.dynTMAretTS02?.value ?? undefined,
    // glycolTMApressureIn: data['telemetry-HVAC-0-dynalene']?.dynTMAsupPS01?.value ?? undefined,
    // glycolTMApressureOut: data['telemetry-HVAC-0-dynalene']?.dynTMAretPS02?.value ?? undefined,
  };
};
...
export const getHVACSubscription = () => {
  return [
    ...
    'telemetry-HVAC-0-glycolChiller03BoosterPump',
    'telemetry-HVAC-0-coldGlycolChiller01',
    'telemetry-HVAC-0-coldGlycolChiller02',
    'telemetry-HVAC-0-comfortGlycolChiller03',
    'telemetry-HVAC-0-ambientFloor1',
    'telemetry-HVAC-0-glycolChiller03SwitchValves',
    'telemetry-HVAC-0-airCirculationFan01ElectricalRoom',
    'telemetry-HVAC-0-airExtractionFan01MRCR',
    'telemetry-HVAC-0-airIntakeFan01MainBuilding',

    //Level 2//
    'telemetry-HVAC-0-crac01',
    'telemetry-HVAC-0-crac02',
    'telemetry-HVAC-0-fancoilUnit01ITOffice',
    'telemetry-HVAC-0-fancoilUnit02BreakRoom',
    'telemetry-HVAC-0-fancoilUnit03ControlRoom',
    'telemetry-HVAC-0-fancoilUnit04ControlRoom',
    'telemetry-HVAC-0-fancoilUnit05ControlRoom',
    'telemetry-HVAC-0-fancoilUnit06ManagersOffice',
    'telemetry-HVAC-0-fancoilUnit07SafetyOffice',
    'telemetry-HVAC-0-fancoilUnit08ElectricalOffice',
    'telemetry-HVAC-0-fancoilUnit09MeetingRoom',
    'telemetry-HVAC-0-fancoilUnit10WorkRoom',
    'telemetry-HVAC-0-fancoilUnit11WorkRoom',
    'telemetry-HVAC-0-fancoilUnit12CoatingOffice',

    //Level 4//
    'telemetry-HVAC-0-airHandlingUnit05WhiteRoom',
    'telemetry-HVAC-0-airHandlingUnit06CleanRoom',
    'telemetry-HVAC-0-airExtractionFan03HighBay',
    'telemetry-HVAC-0-airExtractionFan04Dome',
    ...
    'telemetry-HVAC-0-airHandlingUnit01Dome',
    'telemetry-HVAC-0-airHandlingUnit02Dome',
    'telemetry-HVAC-0-airHandlingUnit03Dome',
    'telemetry-HVAC-0-airHandlingUnit04Dome',
    'telemetry-HVAC-0-airCirculationFan01Lab',
    'telemetry-HVAC-0-airCirculationFan08Pier',
    'telemetry-HVAC-0-airCirculationFan09Pier',
    'telemetry-HVAC-0-airCirculationFan10Pier',
    'telemetry-HVAC-0-airCirculationFan11Pier',
    'telemetry-HVAC-0-airCirculationFan12Pier',
    'telemetry-HVAC-0-airCirculationFan13Pier',
    'telemetry-HVAC-0-airCirculationFan14Pier',
    'telemetry-HVAC-0-airCirculationFan15Pier',
    'telemetry-HVAC-0-airCirculationFan16Lab',
    'telemetry-HVAC-0-airCirculationFan17Lab',
  ];
};
...
export const getHVACTelemetry = (state) => {
  ...
  return {
    ...
    glycolChiller03BoosterPump: HVACData['telemetry-HVAC-0-glycolChiller03BoosterPump'] ?? {},
    coldGlycolChiller01: HVACData['telemetry-HVAC-0-coldGlycolChiller01'] ?? {},
    coldGlycolChiller02: HVACData['telemetry-HVAC-0-coldGlycolChiller02'] ?? {},
    comfortGlycolChiller03: HVACData['telemetry-HVAC-0-comfortGlycolChiller03'] ?? {},
    ambientFloor1: HVACData['telemetry-HVAC-0-ambientFloor1'] ?? {},
    glycolChiller03SwitchValves: HVACData['telemetry-HVAC-0-glycolChiller03SwitchValves'] ?? {},
    airCirculationFan01ElectricalRoom: HVACData['telemetry-HVAC-0-airCirculationFan01ElectricalRoom'] ?? {},
    airExtractionFan01MRCR: HVACData['telemetry-HVAC-0-airExtractionFan01MRCR'] ?? {},
    airIntakeFan01MainBuilding: HVACData['telemetry-HVAC-0-airIntakeFan01MainBuilding'] ?? {},

    //Level 2//
    crac01: HVACData['telemetry-HVAC-0-crac01'] ?? {},
    crac02: HVACData['telemetry-HVAC-0-crac02'] ?? {},
    fancoilUnit01ITOffice: HVACData['telemetry-HVAC-0-fancoilUnit01ITOffice'] ?? {},
    fancoilUnit02BreakRoom: HVACData['telemetry-HVAC-0-fancoilUnit02BreakRoom'] ?? {},
    fancoilUnit03ControlRoom: HVACData['telemetry-HVAC-0-fancoilUnit03ControlRoom'] ?? {},
    fancoilUnit04ControlRoom: HVACData['telemetry-HVAC-0-fancoilUnit04ControlRoom'] ?? {},
    fancoilUnit05ControlRoom: HVACData['telemetry-HVAC-0-fancoilUnit05ControlRoom'] ?? {},
    fancoilUnit06ManagersOffice: HVACData['telemetry-HVAC-0-fancoilUnit06ManagersOffice'] ?? {},
    fancoilUnit07SafetyOffice: HVACData['telemetry-HVAC-0-fancoilUnit07SafetyOffice'] ?? {},
    fancoilUnit08ElectricalOffice: HVACData['telemetry-HVAC-0-fancoilUnit08ElectricalOffice'] ?? {},
    fancoilUnit09MeetingRoom: HVACData['telemetry-HVAC-0-fancoilUnit09MeetingRoom'] ?? {},
    fancoilUnit10WorkRoom: HVACData['telemetry-HVAC-0-fancoilUnit10WorkRoom'] ?? {},
    fancoilUnit11WorkRoom: HVACData['telemetry-HVAC-0-fancoilUnit11WorkRoom'] ?? {},
    fancoilUnit12CoatingOffice: HVACData['telemetry-HVAC-0-fancoilUnit12CoatingOffice'] ?? {},

    //Level 4//
    airHandlingUnit05WhiteRoom: HVACData['telemetry-HVAC-0-airHandlingUnit05WhiteRoom'] ?? {},
    airHandlingUnit06CleanRoom: HVACData['telemetry-HVAC-0-airHandlingUnit06CleanRoom'] ?? {},
    airExtractionFan03HighBay: HVACData['telemetry-HVAC-0-airExtractionFan03HighBay'] ?? {},
    airExtractionFan04Dome: HVACData['telemetry-HVAC-0-airExtractionFan04Dome'] ?? {},

    //Level 5//
    dynaleneSafeties: HVACData['event-HVAC-0-dynaleneSafeties']?.[0] ?? {},
    dynaleneState: HVACData['event-HVAC-0-dynaleneState']?.[0] ?? {},
    dynalene: HVACData['telemetry-HVAC-0-dynalene'] ?? {},
    airHandlingUnit01Dome: HVACData['telemetry-HVAC-0-airHandlingUnit01Dome'] ?? {},
    airHandlingUnit02Dome: HVACData['telemetry-HVAC-0-airHandlingUnit02Dome'] ?? {},
    airHandlingUnit03Dome: HVACData['telemetry-HVAC-0-airHandlingUnit03Dome'] ?? {},
    airHandlingUnit04Dome: HVACData['telemetry-HVAC-0-airHandlingUnit04Dome'] ?? {},
    airCirculationFan01Lab: HVACData['telemetry-HVAC-0-airCirculationFan01Lab'] ?? {},
    airCirculationFan08Pier: HVACData['telemetry-HVAC-0-airCirculationFan08Pier'] ?? {},
    airCirculationFan09Pier: HVACData['telemetry-HVAC-0-airCirculationFan09Pier'] ?? {},
    airCirculationFan10Pier: HVACData['telemetry-HVAC-0-airCirculationFan10Pier'] ?? {},
    airCirculationFan11Pier: HVACData['telemetry-HVAC-0-airCirculationFan11Pier'] ?? {},
    airCirculationFan12Pier: HVACData['telemetry-HVAC-0-airCirculationFan12Pier'] ?? {},
    airCirculationFan13Pier: HVACData['telemetry-HVAC-0-airCirculationFan13Pier'] ?? {},
    airCirculationFan14Pier: HVACData['telemetry-HVAC-0-airCirculationFan14Pier'] ?? {},
    airCirculationFan15Pier: HVACData['telemetry-HVAC-0-airCirculationFan15Pier'] ?? {},
    airCirculationFan16Lab: HVACData['telemetry-HVAC-0-airCirculationFan16Lab'] ?? {},
    airCirculationFan17Lab: HVACData['telemetry-HVAC-0-airCirculationFan17Lab'] ?? {},
  };
};
