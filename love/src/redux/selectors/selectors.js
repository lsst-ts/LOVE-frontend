...
export const getNightreportObservatoryState = (state) => {
  ...
  return {
    ...
    simonyiLockingPinsSystemState: streamData['event-MTMount-0-lockingPinsSystemState']?.[0]?.powerState.value ?? null,
    auxtelAzimuth: streamData['telemetry-ATMCS-0-AzEl_Encoders']?.azimuthCalculatedAngle?.value[0] ?? 0.0,
    auxtelElevation: streamData['telemetry-ATMCS-0-AzEl_Encoders']?.elevationCalculatedAngle?.value[0] ?? 0.0,
