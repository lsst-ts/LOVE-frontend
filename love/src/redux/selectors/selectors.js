...
export const getGlycolSystemData = (state) => {
  const subscriptions = ['telemetry-HVAC-0-glycolSensor', 'telemetry-HVAC-0-dynaleneP05'];

  const data = getStreamsData(state, subscriptions);

  const dummyFlow = 5;
  const dummyTempIn = 10;
  const dummyTempOut = 15;
  const dummyPressureIn = 100;
  const dummyPressureOut = 90;
  return {
    glycolCH01flow: data['telemetry-HVAC-0-glycolSensor']?.supplyFlowChiller01?.value ?? dummyFlow,
    glycolCH01temperatureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyTempChiller01?.value ?? dummyTempIn,
    glycolCH01temperatureOut: data['telemetry-HVAC-0-glycolSensor']?.retTempChiller01?.value ?? 200,
    glycolCH01pressureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyPressChiller01?.value ?? dummyPressureIn,
    glycolCH01pressureOut: data['telemetry-HVAC-0-glycolSensor']?.retPressChiller01?.value ?? dummyPressureOut,
    glycolCH02flow: data['telemetry-HVAC-0-glycolSensor']?.supplyFlowChiller02?.value ?? dummyFlow,
    glycolCH02temperatureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyTempChiller02?.value ?? dummyTempIn,
    glycolCH02temperatureOut: data['telemetry-HVAC-0-glycolSensor']?.retTempChiller02?.value ?? dummyTempOut,
    glycolCH02pressureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyPressChiller02?.value ?? dummyPressureIn,
    glycolCH02pressureOut: data['telemetry-HVAC-0-glycolSensor']?.retPressChiller02?.value ?? dummyPressureOut,
    glycolCH03flow: data['telemetry-HVAC-0-glycolSensor']?.supplyFlowChiller03?.value ?? dummyFlow,
    glycolCH03temperatureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyTempChiller03?.value ?? dummyTempIn,
    glycolCH03temperatureOut: data['telemetry-HVAC-0-glycolSensor']?.retTempChiller03?.value ?? dummyTempOut,
    glycolCH03pressureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyPressChiller03?.value ?? dummyPressureIn,
    glycolCH03pressureOut: data['telemetry-HVAC-0-glycolSensor']?.retPressChiller03?.value ?? dummyPressureOut,
    glycolOSSflow: data['telemetry-HVAC-0-glycolSensor']?.supplyFlowOSS?.value ?? dummyFlow,
    glycolOSStemperatureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyTempOSS?.value ?? dummyTempIn,
    glycolOSStemperatureOut: data['telemetry-HVAC-0-glycolSensor']?.retTempOSS?.value ?? dummyTempOut,
    glycolOSSpressureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyPressOSS?.value ?? dummyPressureIn,
    glycolOSSpressureOut: data['telemetry-HVAC-0-glycolSensor']?.retPressOSS?.value ?? dummyPressureOut,
    glycolSLACflow: data['telemetry-HVAC-0-glycolSensor']?.supplyFlowSLAC?.value ?? dummyFlow,
    glycolSLACtemperatureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyTempSLAC?.value ?? dummyTempIn,
    glycolSLACtemperatureOut: data['telemetry-HVAC-0-glycolSensor']?.retTempSLAC?.value ?? dummyTempOut,
    glycolSLACpressureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyPressSLAC?.value ?? dummyPressureIn,
    glycolSLACpressureOut: data['telemetry-HVAC-0-glycolSensor']?.retPressSLAC?.value ?? dummyPressureOut,
    glycolCRAC01flow: data['telemetry-HVAC-0-glycolSensor']?.supplyFlowCRAC01?.value ?? dummyFlow,
    glycolCRAC01temperatureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyTempCRAC01?.value ?? dummyTempIn,
    glycolCRAC01temperatureOut: data['telemetry-HVAC-0-glycolSensor']?.retTempCRAC01?.value ?? dummyTempOut,
    glycolCRAC01pressureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyPressCRAC01?.value ?? dummyPressureIn,
    glycolCRAC01pressureOut: data['telemetry-HVAC-0-glycolSensor']?.retPressCRAC01?.value ?? dummyPressureOut,
    glycolCRAC02flow: data['telemetry-HVAC-0-glycolSensor']?.supplyFlowCRAC02?.value ?? dummyFlow,
    glycolCRAC02temperatureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyTempCRAC02?.value ?? dummyTempIn,
    glycolCRAC02temperatureOut: data['telemetry-HVAC-0-glycolSensor']?.retTempCRAC02?.value ?? dummyTempOut,
    glycolCRAC02pressureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyPressCRAC02?.value ?? dummyPressureIn,
    glycolCRAC02pressureOut: data['telemetry-HVAC-0-glycolSensor']?.retPressCRAC02?.value ?? dummyPressureOut,
    glycolAHUCRflow: data['telemetry-HVAC-0-glycolSensor']?.supplyFlowAHUCR?.value ?? dummyFlow,
    glycolAHUCRtemperatureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyTempAHUCR?.value ?? dummyTempIn,
    glycolAHUCRtemperatureOut: data['telemetry-HVAC-0-glycolSensor']?.retTempAHUCR?.value ?? dummyTempOut,
    glycolAHUCRpressureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyPressAHUCR?.value ?? dummyPressureIn,
    glycolAHUCRpressureOut: data['telemetry-HVAC-0-glycolSensor']?.retPressAHUCR?.value ?? dummyPressureOut,
    glycolAHUWRflow: data['telemetry-HVAC-0-glycolSensor']?.supplyFlowAHUWR?.value ?? dummyFlow,
    glycolAHUWRtemperatureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyTempAHUWR?.value ?? dummyTempIn,
    glycolAHUWRtemperatureOut: data['telemetry-HVAC-0-glycolSensor']?.retTempAHUWR?.value ?? dummyTempOut,
    glycolAHUWRpressureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyPressAHUWR?.value ?? dummyPressureIn,
    glycolAHUWRpressureOut: data['telemetry-HVAC-0-glycolSensor']?.retPressAHUWR?.value ?? dummyPressureOut,
    glycolDOMEAHU01flow: data['telemetry-HVAC-0-glycolSensor']?.supplyFlowAhuLower1?.value ?? dummyFlow,
    glycolDOMEAHU01temperatureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyTempAhuLower1?.value ?? dummyTempIn,
    glycolDOMEAHU01temperatureOut: data['telemetry-HVAC-0-glycolSensor']?.returnTempAhuLower1?.value ?? dummyTempOut,
    glycolDOMEAHU01pressureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyPressAhuLower1?.value ?? dummyPressureIn,
    glycolDOMEAHU01pressureOut: data['telemetry-HVAC-0-glycolSensor']?.returnPressAhuLower1?.value ?? dummyPressureOut,
    glycolDOMEAHU02flow: data['telemetry-HVAC-0-glycolSensor']?.supplyFlowAhuLower2?.value ?? dummyFlow,
    glycolDOMEAHU02temperatureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyTempAhuLower2?.value ?? dummyTempIn,
    glycolDOMEAHU02temperatureOut: data['telemetry-HVAC-0-glycolSensor']?.returnTempAhuLower2?.value ?? dummyTempOut,
    glycolDOMEAHU02pressureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyPressAhuLower2?.value ?? dummyPressureIn,
    glycolDOMEAHU02pressureOut: data['telemetry-HVAC-0-glycolSensor']?.returnPressAhuLower2?.value ?? dummyPressureOut,
    glycolDOMEAHU03flow: data['telemetry-HVAC-0-glycolSensor']?.supplyFlowAhuLower3?.value ?? dummyFlow,
    glycolDOMEAHU03temperatureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyTempAhuLower3?.value ?? dummyTempIn,
    glycolDOMEAHU03temperatureOut: data['telemetry-HVAC-0-glycolSensor']?.returnTempAhuLower3?.value ?? dummyTempOut,
    glycolDOMEAHU03pressureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyPressAhuLower3?.value ?? dummyPressureIn,
    glycolDOMEAHU03pressureOut: data['telemetry-HVAC-0-glycolSensor']?.returnPressAhuLower3?.value ?? dummyPressureOut,
    glycolDOMEAHU04flow: data['telemetry-HVAC-0-glycolSensor']?.supplyFlowAhuLower4?.value ?? dummyFlow,
    glycolDOMEAHU04temperatureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyTempAhuLower4?.value ?? dummyTempIn,
    glycolDOMEAHU04temperatureOut: data['telemetry-HVAC-0-glycolSensor']?.returnTempAhuLower4?.value ?? dummyTempOut,
    glycolDOMEAHU04pressureIn: data['telemetry-HVAC-0-glycolSensor']?.supplyPressAhuLower4?.value ?? dummyPressureIn,
    glycolDOMEAHU04pressureOut: data['telemetry-HVAC-0-glycolSensor']?.returnPressAhuLower4?.value ?? dummyPressureOut,
    glycolDynalene01flow: data['telemetry-HVAC-0-dynaleneP05']?.dynCH1supCGLYflow?.value ?? dummyFlow, // dynCH01supFS01?
    glycolDynalene01temperatureIn: data['telemetry-HVAC-0-dynaleneP05']?.dynCH01supCGLYtemp?.value ?? dummyTempIn, // dynCH01supTS05
    glycolDynalene01temperatureOut: data['telemetry-HVAC-0-dynaleneP05']?.dynCH01retCGLYtemp?.value ?? dummyTempOut,
    glycolDynalene01pressureIn: data['telemetry-HVAC-0-dynaleneP05']?.dynCH01supCGLYpres?.value ?? dummyPressureIn, // dynCH01supPS11
    glycolDynalene01pressureOut: data['telemetry-HVAC-0-dynaleneP05']?.dynCH01retCGLYpres?.value ?? dummyPressureOut,
    glycolDynalene02flow: data['telemetry-HVAC-0-dynaleneP05']?.dynCH2supGPGLYflow?.value ?? dummyFlow, // dynCH02supFS02
    glycolDynalene02temperatureIn: data['telemetry-HVAC-0-dynaleneP05']?.dynCH02supGPGLYtemp?.value ?? dummyTempIn, // dynCH02supTS07
    glycolDynalene02temperatureOut: data['telemetry-HVAC-0-dynaleneP05']?.dynCH02retGPGLYtemp?.value ?? dummyTempOut,
    glycolDynalene02pressureIn: data['telemetry-HVAC-0-dynaleneP05']?.dynCH02supGPGLYpres?.value ?? dummyPressureIn, // dynCH02supPS13
    glycolDynalene02pressureOut: data['telemetry-HVAC-0-dynaleneP05']?.dynCH02retGPGLYpres?.value ?? dummyPressureOut,
    glycolTMAflow: data['telemetry-HVAC-0-dynaleneP05']?.dynTMAsupFS03?.value ?? dummyFlow,
    glycolTMAtemperatureIn: data['telemetry-HVAC-0-dynaleneP05']?.dynTMAsupTS01?.value ?? dummyTempIn,
    glycolTMAtemperatureOut: data['telemetry-HVAC-0-dynaleneP05']?.dynTMAretTS02?.value ?? dummyTempOut,
    glycolTMApressureIn: data['telemetry-HVAC-0-dynaleneP05']?.dynTMAsupPS01?.value ?? dummyPressureIn,
    glycolTMApressureOut: data['telemetry-HVAC-0-dynaleneP05']?.dynTMAretPS02?.value ?? dummyPressureOut,
  };
};
